<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="casefour.master" CodeBehind="gioithieu.aspx.vb" Inherits="hcmpc.gioithieu" %>
    ...
    <div id="middleTwo">   
        ...
        <div id="recentNews">
						<div class="section subHeading">
					        <h1>Cẩm Nang Văn Hóa EVNHCMC</h1>
                            </div>				

        </div>	
        </div>
                <br />
	    <div class="magic-slider-wrapper" style=" width:100%;">
		    <div class="magic-slider preload" id="magic-slider-1">
			    <div class="panel">
				    <div class="panel-wrapper" style=" background:url(images/bg-vh-evnhcmc.jpg); height:550px;background-repeat: no-repeat; ">                        
                ...
                <div class="panel">
				    <div class="panel-wrapper" style=" background:url(images/bg-vh-evnhcmc.jpg); background-repeat: no-repeat;background-size: 100% 100%;">
                ...
                <div class="panel">
				    <div class="panel-wrapper" style=" background:url(images/bg-vh-evnhcmc.jpg);height:550px;">
...
<asp:Content ID="FooterContent" runat="server" ContentPlaceHolderID="FooterContent">   
	...
	<script type="text/javascript">
	    $().ready(function () {
	        $('#magic-slider-1').magicSlider({ autoSlide: true, autoCycle: true, slideDirection: "horizontal", autoSlideStopWhenClicked: true });
