...
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#6298E1">
  <tr>
    <td height="24" nowrap background="images/th_bg.gif"><font color="#FFFFFF"><strong>上传作品管理</strong></font></td>
  </tr>
<tr><td>
<table Width="100%" border=0 align="center" cellpadding=0 cellspacing=0 bgcolor="#EBF2F9" class=border-all>
  ...
  <form name="form1" method="get" action="?path=">
    <tr> 
      <td height="20" sytle="line-height:150%">&nbsp;上传目录的所有文件列表如下</td>
    </tr>
  </form>
</table>
</td></tr></table>
...
<table Width="100%" border="0" align=center cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  <tr bgcolor="#8DB5E9"> 
    <td Width="6%" height=23 align="center" background="images/th_bg.gif"><span class="style8 STYLE1"><strong>类型</strong></span></td>
    <td Width="51%" align="center" background="images/th_bg.gif"><span class="style8 STYLE1"><strong>文件地址</strong></span></td>
    <td Width="13%" align="center" background="images/th_bg.gif"><span class="style8 STYLE1"><strong>大小</strong></span></td>
    <td Width="23%" align="center" background="images/th_bg.gif"><span class="style8 STYLE1"><strong>上传日期</strong></span></td>
    <td Width="7%" align="center" background="images/th_bg.gif"><span class="style8 STYLE1"><strong>管理</strong></span></td>
  </tr>
<%
