<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/myniengiam2.master" CodeBehind="NhapA6.aspx.vb" Inherits="niengiam.NhapA6" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
       ...
       <div>       
           <h1 class="xanh">TỶ LỆ TỔN THẤT ĐIỆN NĂNG THEO TỪNG ĐƠN VỊ<br /><br />
           <div align="center">                
           ...
           <div align="right" style="color:#3079ed;font-weight:bold;padding-right:10px;">ĐVT: %</div>
       </div><br />
       <div class="mpanel">            
