<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/myniengiam1.Master" CodeBehind="3j_11.aspx.vb" Inherits="niengiam.WebForm11" %>
    ...
    <telerik:RadGrid ID="GridVanBan" runat="server" AllowSorting="True" 
        ...
        AutoGenerateColumns="False"  >
                    ...
                    <MasterTableView AllowMultiColumnSorting="True"   
                        CommandItemDisplay="Top"  Font-Bold="False" Caption="THỐNG KÊ SỰ CỐ TRẠM BIẾN THẾ THEO THỜI GIAN"
                        Font-Italic="False"   
                       >
