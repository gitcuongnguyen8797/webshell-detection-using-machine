<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/hcmpcadmin.master" CodeBehind="nhapaccess.aspx.vb" Inherits="hcmpc.nhapaccess" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <script type="text/javascript">
         function isFormValid() {
             ...
             if (txtName.value == '') {
                 alert("Vui lòng tiêu đề cấp bậc!");
                 txtName.focus();
                 return false;
             }            
	...
	<div class="m">
		<div id="toolbar" class="toolbar-list">
            <ul>
                ...
                <a class="toolbar" href="dsaccess.aspx">
            ...
            <div class="clr"></div>
					...
					<div class="pagetitle icon-48-levels-add"><h2>Quản lý người dùng: <%=IIf(Request("ID") = "", "Thêm cấp độ truy cập", "Chỉnh sửa cấp độ truy cập")%></h2></div>
			</div>
</div>
...
<table border="0" width="100%" cellspacing="5">  
    <tr>
        <td>
            Tiêu đề cấp bậc <span style="color:Red">*</span>    
        </td>
        <td>
            &nbsp;
        </td>
