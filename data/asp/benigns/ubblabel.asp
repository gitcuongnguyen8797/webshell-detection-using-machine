...
<img onclick=bold() align=absmiddle src="images/Ubb_bold.gif" width="22" height="22" alt="粗体" border="0"
><img onclick=italicize() align=absmiddle src="images/Ubb_italicize.gif" width="23" height="22" alt="斜体" border="0"
><img onclick=underline() align=absmiddle src="images/Ubb_underline.gif" width="23" height="22" alt="下划线" border="0"
><img onclick=center() align=absmiddle src="images/Ubb_center.gif" width="22" height="22" alt="居中" border="0"
><img onclick=hyperlink() align=absmiddle src="images/Ubb_url.gif" width="22" height="22" alt="超级连接" border="0"
><img onclick=emails() align=absmiddle src="images/Ubb_email.gif" width="23" height="22" alt="Email连接" border="0"
><img onclick=image() align=absmiddle src="images/Ubb_image.gif" width="23" height="22" alt="图片" border="0"
><img onclick=flash() align=absmiddle src="images/Ubb_swf.gif" width="23" height="22" alt="Flash图片" border="0"
><img onclick=Cdir() align=absmiddle src="images/Ubb_Shockwave.gif" width="23" height="22" alt="Shockwave文件" border="0"
><img onclick=Crm() align=absmiddle src="images/Ubb_rm.gif" width="23" height="22" alt="realplay视频文件" border="0"
><img onclick=Cwmv() align=absmiddle src="images/Ubb_mp.gif" width="23" height="22" alt="Media Player视频文件" border="0"
><img onclick=Cmov() align=absmiddle src="images/Ubb_qt.gif" width="23" height="22" alt="QuickTime视频文件" border="0"
><img onclick=showcode() align=absmiddle src="images/Ubb_code.gif" width="22" height="22" alt="代码" border="0"
><img onclick=quote() align=absmiddle src="images/Ubb_quote.gif" width="23" height="22" alt="引用" border="0"
><IMG onclick=setfly() align=absmiddle height=22 alt=飞行字 src="images/Ubb_fly.gif" width=23 border=0
><IMG onclick=move() align=absmiddle height=22 alt=移动字 src="images/Ubb_move.gif" width=23 border=0
><IMG onclick=glow() align=absmiddle height=22 alt=发光字 src="images/Ubb_glow.gif" width=23 border=0
><IMG onclick=shadow() align=absmiddle height=22 alt=阴影字 src="images/Ubb_shadow.gif" width=23 border=0
><img onclick=openhelp() align=absmiddle src="images/Ubb_Help.gif" width="23" height="22" alt="帮助" border="0"><br>
字体：
...
&nbsp;
<IMG align=absmiddle onclick=openemot() src="images/emot.gif" border=0 alt=选择心情图标 style="cursor:hand">
<%end sub%>