...
class WP_MS_Sites_List_Table extends WP_List_Table {
	...
	public function column_cb( $item ) {
		...
		if ( ! is_main_site( $blog['blog_id'] ) ) :
			...
			?><?php echo $blog['blog_id']; ?><?php
				/* translators: %s: Site URL. */
				printf( __( 'Select %s' ), $blogname );
				?><?php echo $blog['blog_id']; ?><?php echo esc_attr( $blog['blog_id'] ); ?><?php
		endif;
	}
	...
	public function column_blogname( $blog ) {
		...
		?><?php echo esc_url( network_admin_url( 'site-info.php?id=' . $blog['blog_id'] ) ); ?><?php echo $blogname; ?><?php $this->site_states( $blog ); ?>