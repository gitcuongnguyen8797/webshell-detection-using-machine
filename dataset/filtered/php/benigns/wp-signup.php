...
function show_blog_form( $blogname = '', $blog_title = '', $errors = '' ) {
	...
	?><?php _e( 'Privacy:' ); ?><?php _e( 'Allow search engines to index this site.' ); ?><?php echo $blog_public_on_checked; ?><?php _e( 'Yes' ); ?><?php echo $blog_public_off_checked; ?><?php _e( 'No' ); ?><?php
	/**
...
function show_user_form( $user_name = '', $user_email = '', $errors = '' ) {
	...
	?><?php echo esc_attr( $user_name ); ?><?php echo $errmsg_username_aria; ?><?php _e( '(Must be at least 4 characters, lowercase letters and numbers only.)' ); ?><?php
	// Email address.
	...
	?><?php echo esc_attr( $user_email ); ?><?php echo $errmsg_email_aria; ?><?php _e( 'Your registration email is sent to this address. (Double-check your email address before continuing.)' ); ?><?php
	// Extra fields.
...
function signup_another_blog( $blogname = '', $blog_title = '', $errors = '' ) {
	...
	if ( ! empty( $blogs ) ) {
		?><?php _e( 'Sites you are already a member of:' ); ?><?php
				foreach ( $blogs as $blog ) {
					$home_url = get_home_url( $blog->userblog_id );
					echo '<li><a href="' . esc_url( $home_url ) . '">' . $home_url . '</a></li>';
				}
				?><?php } ?><?php _e( 'If you are not going to use a great site domain, leave it for a new user. Now have at it!' ); ?><?php
		/**
		...
		?><?php show_blog_form( $blogname, $blog_title, $errors ); ?><?php esc_attr_e( 'Create Site' ); ?><?php
}
...
function signup_user( $user_name = '', $user_email = '', $errors = '' ) {
	...
	?><?php
		...
		?><?php show_user_form( $user_name, $user_email, $errors ); ?><?php if ( 'blog' === $active_signup ) : ?><?php elseif ( 'user' === $active_signup ) : ?><?php else : ?><?php _e( 'Create a site or only a username:' ); ?><?php checked( $signup_for, 'blog' ); ?><?php _e( 'Gimme a site!' ); ?><?php checked( $signup_for, 'user' ); ?><?php _e( 'Just a username, please.' ); ?><?php endif; ?><?php esc_attr_e( 'Next' ); ?><?php
}
...
function confirm_user_signup( $user_name, $user_email ) {
	...
	?><?php _e( 'But, before you can start using your new username, <strong>you must activate it</strong>.' ); ?><?php
	/* translators: %s: Email address. */
	printf( __( 'Check your inbox at %s and click the link given.' ), '<strong>' . $user_email . '</strong>' );
	?><?php _e( 'If you do not activate your username within two days, you will have to sign up again.' ); ?><?php
	/** This action is documented in wp-signup.php */
	do_action( 'signup_finished' );
}
...
function signup_blog( $user_name = '', $user_email = '', $blogname = '', $blog_title = '', $errors = '' ) {
	...
	?><?php echo esc_attr( $user_name ); ?><?php echo esc_attr( $user_email ); ?><?php
		/** This action is documented in wp-signup.php */
		do_action( 'signup_hidden_fields', 'validate-site' );
		?><?php show_blog_form( $blogname, $blog_title, $errors ); ?><?php esc_attr_e( 'Sign up' ); ?><?php
}
...
function confirm_blog_signup( $domain, $path, $blog_title, $user_name = '', $user_email = '', $meta = array() ) {
	...
	?><?php _e( 'But, before you can start using your site, <strong>you must activate it</strong>.' ); ?><?php
	/* translators: %s: Email address. */
	printf( __( 'Check your inbox at %s and click the link given.' ), '<strong>' . $user_email . '</strong>' );
	?><?php _e( 'If you do not activate your site within two days, you will have to sign up again.' ); ?><?php _e( 'Still waiting for your email?' ); ?><?php _e( 'If you have not received your email yet, there are a number of things you can do:' ); ?><?php _e( 'Wait a little longer. Sometimes delivery of email can be delayed by processes outside of our control.' ); ?><?php _e( 'Check the junk or spam folder of your email client. Sometime emails wind up there by mistake.' ); ?><?php
			/* translators: %s: Email address. */
