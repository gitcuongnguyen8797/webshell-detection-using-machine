<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="dslichcd.aspx.vb" MasterPageFile="~/hcmpcadmin.master" Inherits="hcmpc.dslichcd" %>
		...
		<div id="toolbar" class="toolbar-list">
            <ul>
                <li id="toolbar-new" class="button">
                    <a class="toolbar" href="lichcd.aspx">
			...
			<div class="pagetitle icon-48-article"><h2>Quản lý Lịch Cắt Điện: Bài viết</h2></div>
		</div>
</div>
                    ...
                    <MasterTableView DataKeyNames="Article_ID">                
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="Article_ID" HeaderText="Article_ID" UniqueName="Article_ID"
                             ...
                             <telerik:GridHyperLinkColumn DataNavigateUrlFormatString="{0}" Target="_blank"
                                DataNavigateUrlFields="FileName" Text="Xem File" HeaderText="Xem file">
                                <HeaderStyle Font-Bold="true" />                  
                            </telerik:GridHyperLinkColumn>  

                            <telerik:GridHyperLinkColumn DataNavigateUrlFormatString="lichcd.aspx?ID={0}"
                            ...
                            <telerik:GridBoundColumn DataField="DonViName" HeaderText="Đơn vị">    
