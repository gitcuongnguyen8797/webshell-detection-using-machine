...
if ( has_action( 'welcome_panel' ) && current_user_can( 'edit_theme_options' ) ) :
	...
	?><?php echo esc_attr( $classes ); ?><?php wp_nonce_field( 'welcome-panel-nonce', 'welcomepanelnonce', false ); ?><?php echo esc_url( admin_url( '?welcome=0' ) ); ?><?php esc_attr_e( 'Dismiss the welcome panel' ); ?><?php _e( 'Dismiss' ); ?><?php
		/**
