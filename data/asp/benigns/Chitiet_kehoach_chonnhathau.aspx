<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Chitiet_kehoach_chonnhathau.aspx.vb" MasterPageFile="~/hcmpcadmin.master" Inherits="hcmpc.Chitiet_kehoach_chonnhathau" %>
		...
		<div id="toolbar" class="toolbar-list">
            <ul>
                <li id="toolbar-new" class="button">
                    <a class="toolbar" href="Chongoithau.aspx">
			...
			<div class="pagetitle icon-48-article"><h2>Thông tin chi tiết kế hoạch lựa chọn nhà thầu</h2></div>
		</div>
</div>
                ...
                <telerik:RadGrid ID="mygrid" runat="server" AutoGenerateColumns="False" GridLines="None"
                    ...
                    <MasterTableView DataKeyNames="Id">                
                        <Columns>
                            ...
                            <telerik:GridButtonColumn  DataTextField="STT" Text="STT"
                                UniqueName="STT" HeaderText="STT">
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="90" />
                            </telerik:GridButtonColumn>
                            <telerik:GridBoundColumn DataField="Sohieu"
                                UniqueName="Sohieu" HeaderText="S/Hiệu gói thầu">    
                                <HeaderStyle Font-Bold="true" />                                                  
                            </telerik:GridBoundColumn> 

                            <telerik:GridBoundColumn DataField="Tengoithau" 
                                UniqueName="Tengoithau" HeaderText="Tên gói thầu">    
                                <HeaderStyle Font-Bold="true" Width="120" HorizontalAlign="Center" />                                                  
                            </telerik:GridBoundColumn> 

                              <telerik:GridBoundColumn DataField="Giagoithau" 
                                UniqueName="Giagoithau" HeaderText="Giá gói thầu">    
                                <HeaderStyle Font-Bold="true" Width="90" HorizontalAlign="Center" />                                                  
                            </telerik:GridBoundColumn> 


                            <telerik:GridBoundColumn DataField="Nguonvon" 
                                UniqueName="Nguonvon" HeaderText="Nguồn vốn">    
                                <HeaderStyle Font-Bold="true" Width="90" HorizontalAlign="Center" />                                                  
                            </telerik:GridBoundColumn> 


                            <telerik:GridBoundColumn DataField="HinhthuchonNT" 
                                UniqueName="HinhthuchonNT" HeaderText="Hình thức lựa chọn NT">    
                                <HeaderStyle Font-Bold="true" />                                                  
                            </telerik:GridBoundColumn> 

                             <telerik:GridBoundColumn DataField="ThoigianchonNT" 
                                UniqueName="ThoigianchonNT" HeaderText="Thời gian lựa chọn NT">    
                                <HeaderStyle Font-Bold="true" Width="90" HorizontalAlign="Center"/>                                                  
                            </telerik:GridBoundColumn> 

                            
                             <telerik:GridBoundColumn DataField="HinhthucHD" 
                                UniqueName="HinhthucHD" HeaderText="Hình thức HĐ">    
                                <HeaderStyle Font-Bold="true" />                                                  
                            </telerik:GridBoundColumn> 

                             <telerik:GridBoundColumn DataField="ThoigianHD" 
                                UniqueName="ThoigianHD" HeaderText="Thời gian thực hiện HĐ">    
                                <HeaderStyle Font-Bold="true" Width="90" HorizontalAlign="Center" />                                                  
                            </telerik:GridBoundColumn> 
                                                                                
                            <telerik:GridBoundColumn DataField="LanguageName" HeaderText="Ngôn ngữ" Visible="false">    
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="true" Width="50" />     
                                <ItemStyle HorizontalAlign="Center" />                                              
                            </telerik:GridBoundColumn>              
                            <telerik:GridBoundColumn DataField="ID" HeaderText="ID" UniqueName="ID" Visible="false">    
                                <HeaderStyle Font-Bold="true" HorizontalAlign="Center" Width="50"/>                           
                                <ItemStyle HorizontalAlign="Center" />
                            </telerik:GridBoundColumn>
                        </Columns>
                        <NoRecordsTemplate>
