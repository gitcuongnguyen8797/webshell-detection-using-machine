<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/hcmpcadmin.master" CodeBehind="dsthuvienkythuat.aspx.vb" Inherits="hcmpc.dsthuvienkythuat" %>
		...
		<div id="toolbar" class="toolbar-list">
            <ul>
                <li id="toolbar-new" class="button">
                    <a class="toolbar" href="nhapthuvienkythuat.aspx">
			...
			<div class="pagetitle icon-48-article"><h2>Quản lý Pháp chế: Pháp chế</h2></div>
		</div>
</div>
    ...
    <div class="m">
        <fieldset id="filter-bar">
		    ...
		    <div class="filter-select fltrt">
                <select onchange="this.form.submit()" class="inputbox" id="filter_loaivanban" runat="Server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <telerik:RadGrid ID="mygrid" runat="server" AutoGenerateColumns="False" GridLines="None"
                    ...
                    <MasterTableView DataKeyNames="VanBan_ID">                
                        <Columns>
                            <telerik:GridClientSelectColumn UniqueName="ClientSelectColumn">
                               <HeaderStyle Width="50px" HorizontalAlign="Center" />
                               <ItemStyle HorizontalAlign="Center" />
                           </telerik:GridClientSelectColumn>
                            <telerik:GridBoundColumn DataField="VanBan_ID" HeaderText="VanBan_ID" UniqueName="VanBan_ID"
                                Visible="false">
                            </telerik:GridBoundColumn>
                            <telerik:GridHyperLinkColumn DataNavigateUrlFormatString="nhapthuvienkythuat.aspx?ID={0}"
                                DataNavigateUrlFields="VanBan_ID" SortExpression="VanBan_ID" UniqueName="EditArticle" DataTextField="Title" HeaderText="Tiêu đề">
                            ...
                            <telerik:GridBoundColumn DataField="NgayBanHanh" DataType="System.DateTime" HeaderText="Ngày ban hành"
                                SortExpression="NgayBanHanh" DataFormatString="{0:dd/MM/yyyy}" UniqueName="NgayBanHanh">
