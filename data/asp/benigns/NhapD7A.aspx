<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="NhapD7A.aspx.vb" Inherits="niengiam.NhapD7A" MasterPageFile="~/myniengiam2.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

<%=sScriptUpDown%>
<script type="text/javascript" language="javascript" src="Scripts/scriptNienGiam.js"></script>
...
<div class="container">
       ...
       <div>       
           <h1 class="xanh">SỐ LẦN GIÁN ĐOẠN CUNG CẤP ĐIỆN (SAIFI) TỪNG ĐƠN VỊ<br /><br />
           <div align="center">                
           ...
           <div align="right" style="color:#3079ed;font-weight:bold;padding-right:10px;">ĐVT: Lần</div>
       </div><br />
       <div class="mpanel">            
           <div id="nhap1">
