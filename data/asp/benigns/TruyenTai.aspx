<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TruyenTai.aspx.vb" Inherits="DoDem.TruyenTai" MasterPageFile="~/MasterOne.Master" %>
...
function ContentPlaceHolder1_ctl00_cbThang_onclick() {
                ...
                <div style="line-height: 30px;" class="displayinline">            
                    <div id="ContentPlaceHolder1_ctl00_Panel2" class="displayinline">	
                            <div style="float: left; width: 100%; padding-left: 2px; height: 34px; padding-top:10px;">
                                ...
                                <telerik:RadComboBox ID="txtThang" runat="server" Width="75px"
                                    Skin="Windows7" AutoPostBack="True" Font-Bold="False" Font-Size="11pt">
                                    <Items>
                                        <telerik:RadComboBoxItem runat="server" Text="Tháng 1" Value="1" />
                                        <telerik:RadComboBoxItem runat="server" Text="Tháng 2" Value="2" />
                                        <telerik:RadComboBoxItem runat="server" Text="Tháng 3" Value="3" />
                                        <telerik:RadComboBoxItem runat="server" Text="Tháng 4" Value="4" />
                                        <telerik:RadComboBoxItem runat="server" Text="Tháng 5" Value="5" />
                                        <telerik:RadComboBoxItem runat="server" Text="Tháng 6" Value="6" />
                                        <telerik:RadComboBoxItem runat="server" Text="Tháng 7" Value="7" />
                                        <telerik:RadComboBoxItem runat="server" Text="Tháng 8" Value="8" />
                                        <telerik:RadComboBoxItem runat="server" Text="Tháng 9" Value="9" />
                                        <telerik:RadComboBoxItem runat="server" Text="Tháng 10" Value="10" />
                                        <telerik:RadComboBoxItem runat="server" Text="Tháng 11" Value="11" />
                                        <telerik:RadComboBoxItem runat="server" Text="Tháng 12" Value="12" />
                                    </Items>
                                </telerik:RadComboBox>

                                 <telerik:RadNumericTextBox ID="txtNam" runat="server" MaxValue="2099" 
                                    MinValue="2000" Width="65px" Font-Size="11pt" Height="15px" 
                                    ShowSpinButtons="True" Skin="Windows7" Value="2014" 
                                    DataType="System.Int32" MaxLength="4" AutoPostBack="True" 
                                    Font-Bold="False">
          ...
          <table style="width: 100%;" border="0">
                            ...
                            <td>
                               <div style="vertical-align:top">                                   
                                    ...
                                    <script type="text/javascript">
                                        ...
                                        function drawChart1(src, title) {
                                            var chart_div = new google.visualization.ChartWrapper({
                                            "containerId": "chart_div",
                                            "dataSourceUrl": src,
                                            "refreshInterval": 3600,
                                            'options': { 'titleTextStyle': { 'bold': true, 'color': '#000', 'fontSize': 16 }, 'series': { '0': { 'errorBars': { 'errorType': 'none' }, 'pointSize': 7 }, '1': { 'pointSize': 7, 'targetAxisIndex': 0 }, '2': { 'pointSize': 7 }, '3': { 'pointSize': 7} }, 'curveType': '', 'animation': { 'duration': 500 }, 'backgroundColor': { 'fill': '#ffffff' }, 'width': 850, 'lineWidth': 2, 'hAxis': { 'useFormatFromData': true, 'title': '', 'minValue': null, 'viewWindowMode': null, 'viewWindow': null, 'maxValue': null }, 'vAxes': [{ 'useFormatFromData': true, 'title': 'S\u1ea3n l\u01b0\u1ee3ng (kWh)', 'minValue': null, 'logScale': false, 'viewWindow': { 'min': null, 'max': null }, 'maxValue': null }, { 'useFormatFromData': true, 'minValue': null, 'logScale': false, 'viewWindow': { 'min': null, 'max': null }, 'maxValue': null}], 'booleanRole': 'certainty', 'title': title, 'height': 400, 'interpolateNulls': true, 'domainAxis': { 'direction': 1 }, 'legend': 'right', 'focusTarget': 'category', 'annotations': { 'domain': {} }, 'tooltip': {} }, 'state': {}, 'view': {}, 'isDefaultVisualization': false, 'chartType': 'LineChart', 'chartName': 'Bi\u1ec3u \u0111\u1ed33'
                                            });
                                            chart_div.draw();                                            
                                        }
                                    </script>
                        ...
                        Skin="WebBlue" AllowFilteringByColumn="False" CellSpacing="0" GridLines="None" runat="server" MasterTableView-NoMasterRecordsText="<center>Chưa có dữ liệu tìm thấy.</center>">
                                        ...
                                        <MasterTableView AutoGenerateColumns="false">                                
                                            <Columns>
                                                 <telerik:GridDateTimeColumn DataField="NGAYHIENTAI" DataType="System.DateTime" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" 
                                                    FilterControlAltText="Filter NGAYHIENTAI column" HeaderText="NGÀY"  DataFormatString="{0:dd/MM/yyyy}"
                                                    UniqueName="NGAYHIENTAI">
                                                ...
                                                <telerik:GridNumericColumn DataField="TONGGIAO" DecimalDigits="1"  HeaderStyle-HorizontalAlign="Right"
                                                    ...
                                                    UniqueName="TONGGIAO" DataType="System.Decimal"  DataFormatString="{0:p}">
                                                ...
                                                <telerik:GridNumericColumn DataField="TONGNHAN" DecimalDigits="1"  HeaderStyle-HorizontalAlign="Right"
                                                    ...
                                                    UniqueName="TONGNHAN" DataType="System.Decimal"  DataFormatString="{0:#}">
                                                    <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                                </telerik:GridNumericColumn>
                                            </Columns>
                                        </MasterTableView>                            
