<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="NhapD3.aspx.vb"  MasterPageFile="~/myniengiam2.master" Inherits="niengiam.NhapD3"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div class="container">
       ...
       <div>       
           <h1 class="xanh">SỰ CỐ LƯỚI ĐIỆN HẠ THẾ TỪNG CÔNG TY ĐIỆN LỰC<br /><br />
           <div align="center">                
           ...
           <div align="right" style="color:#3079ed;font-weight:bold;padding-right:10px;">ĐVT: Số vụ-Số 
               vụ/100 km</div>
       </div><br />
       <div class="mpanel">            
