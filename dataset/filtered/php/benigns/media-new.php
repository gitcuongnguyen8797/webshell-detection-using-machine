...
?><?php echo esc_html( $title ); ?><?php echo esc_url( admin_url( 'media-new.php' ) ); ?><?php echo esc_attr( $form_class ); ?><?php media_upload_form(); ?><?php echo absint( $post_id ); ?><?php echo absint( $post_id ); ?><?php wp_nonce_field( 'media-form' ); ?>