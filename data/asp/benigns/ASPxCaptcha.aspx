...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e) {
        ASPxCaptcha1.Enabled = !chbDisabled.Checked;
        ASPxCaptcha1.RightToLeft = chbRtl.Checked ? DefaultBoolean.True : DefaultBoolean.False;
        RtlContainer.RightToLeft = ASPxCaptcha1.RightToLeft;
...
<asp:Content runat="server" ID="Content3" ContentPlaceHolderID="phHead">
    <script type="text/javascript" src="Scripts/PreviewHelpers/Captha.js"></script>
</asp:Content>


<asp:Content ID="Content2" ContentPlaceHolderID="phComponent" runat="Server">
    <dx:ASPxCaptcha ID="ASPxCaptcha1" runat="server" ClientInstanceName="capthca" Width="420">
        <ClientSideEvents Init="function(s, e) { new ASPxCaptchaPreviewHelper(s); }" />
    </dx:ASPxCaptcha>
</asp:Content>
        ...
        <tr>
            ...
            <td>
                <dx:ASPxCheckBox runat="server" ID="chbShowLoadingPanel" SkinID="Option" ClientInstanceName="chbShowLoadingPanel">
                    <ClientSideEvents CheckedChanged="function(s,e){ ASPxTBHelper.SetControlLoadingPanelVisibility(capthca, s.GetChecked()); }" 
                        Init="function(s,e){ ASPxTBHelper.SetControlLoadingPanelVisibility(capthca, s.GetChecked()); }" />
                </dx:ASPxCheckBox>
            </td>
        </tr>
        <tr>
