...
class WP_Plugin_Install_List_Table extends WP_List_Table {
	...
	public function no_items() {
		if ( isset( $this->error ) ) { ?><?php echo $this->error->get_error_message(); ?><?php _e( 'Try Again' ); ?><?php } else { ?><?php _e( 'No plugins found. Try a different search.' ); ?><?php
		}
	}
	...
	public function display() {
		...
		?><?php echo implode( ' ', $this->get_table_classes() ); ?><?php
		$this->screen->render_screen_reader_content( 'heading_list' );
		?><?php echo $data_attr; ?><?php $this->display_rows_or_placeholder(); ?><?php
	...
	protected function display_tablenav( $which ) {
		...
		if ( 'top' === $which ) {
			...
			?><?php
					...
					?><?php $this->pagination( $which ); ?><?php } else { ?><?php $this->pagination( $which ); ?><?php
		}
	}
	...
	public function display_rows() {
		...
		foreach ( (array) $this->items as $plugin ) {
			...
			?><?php echo sanitize_html_class( $plugin['slug'] ); ?><?php
			if ( ! $compatible_php || ! $compatible_wp ) {
			...
			?><?php echo esc_url( $details_link ); ?><?php echo $title; ?><?php echo esc_url( $plugin_icon_url ); ?><?php
					if ( $action_links ) {
						echo '<ul class="plugin-action-buttons"><li>' . implode( '</li><li>', $action_links ) . '</li></ul>';
					}
					?><?php echo $description; ?><?php echo $author; ?><?php
					wp_star_rating(
						array(
					...
					?><?php echo number_format_i18n( $plugin['num_ratings'] ); ?><?php _e( 'Last Updated:' ); ?><?php
