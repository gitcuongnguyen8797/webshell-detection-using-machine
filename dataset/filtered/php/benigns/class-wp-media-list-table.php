...
class WP_Media_List_Table extends WP_List_Table {
	...
	public function views() {
		...
		?><?php $this->view_switcher( $mode ); ?><?php
				...
				?><?php esc_html_e( 'Search' ); ?><?php _admin_search_query(); ?><?php
	}
	...
	public function column_cb( $item ) {
		...
		if ( current_user_can( 'edit_post', $post->ID ) ) {
			?><?php echo $post->ID; ?><?php
				...
				?><?php echo $post->ID; ?><?php echo $post->ID; ?><?php
		}
	}
	...
	public function column_title( $post ) {
		...
		?><?php echo $class; ?><?php
			...
			if ( $thumb ) :
				?><?php echo sanitize_html_class( $mime . '-icon' ); ?><?php echo $thumb; ?><?php
			endif;
	...
	public function display_rows() {
		...
		while ( have_posts() ) :
			...
			?><?php echo $post->ID; ?><?php echo trim( ' author-' . $post_owner . ' status-' . $post->post_status ); ?><?php $this->single_row_columns( $post ); ?>