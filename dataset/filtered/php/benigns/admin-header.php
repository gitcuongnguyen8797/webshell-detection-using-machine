...
?><?php echo esc_html( $admin_title ); ?><?php
...
?><?php echo esc_js( admin_url( 'admin-ajax.php', 'relative' ) ); ?><?php echo esc_js( $current_screen->id ); ?><?php echo esc_js( $current_screen->post_type ); ?><?php echo esc_js( $admin_body_class ); ?><?php echo esc_js( $wp_locale->number_format['thousands_sep'] ); ?><?php echo esc_js( $wp_locale->number_format['decimal_point'] ); ?><?php echo (int) is_rtl(); ?><?php
...
?><?php echo $admin_body_classes; ?><?php
// Make sure the customize body classes are correct as early as possible.
if ( current_user_can( 'customize' ) ) {
	wp_customize_support_script();
}
?><?php require ABSPATH . 'wp-admin/menu-header.php'; ?><?php
/**
