<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/myniengiam2.master" CodeBehind="NhapG4.aspx.vb" Inherits="niengiam.NhapG4" %>
...
<div class="container">
       ...
       <div>       
           <h1 class="xanh">CÁN BỘ KHOA HỌC KỸ THUẬT, CHUYÊN MÔN NGHIỆP VỤ<br /><br />
           <div align="center">                
   ...
   <script language="javascript">
       document.getElementById('ctl00_ContentPlaceHolder1_txt83SoLieu').style.display = '';
       document.getElementById('ctl00_ContentPlaceHolder1_txt97SoLieu').style.display = 'none';
   </script>
</asp:Content>
