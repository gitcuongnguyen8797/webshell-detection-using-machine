...
if right(nt2003.site_setting(23),1)<>"/" then
	UploadDir="" & nt2003.site_setting(23) & "/"
else
	UploadDir="" & nt2003.site_setting(23)
end if
...
sub showpage2(sfilename,totalnumber,maxperpage)
	...
	if totalnumber mod maxperpage=0 then
  	...
  	strTemp= "<table class=border border=0 cellspacing=1 width=100% cellpadding=0 align='center'><form name='showpages' method='Post' action='" & sfilename & "'><tr><td class=tdbg>"
