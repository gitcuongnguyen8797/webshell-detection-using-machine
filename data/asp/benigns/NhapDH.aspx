<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="NhapDH.aspx.vb" Inherits="niengiam.NhapDH" MasterPageFile="~/myniengiam2.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <div class="container">
       ...
       <div>       
           <h1 class="xanh">THÀNH TÍCH THI ĐUA TOÀN TỔNG CÔNG TY<br />Năm : <asp:Label ID="lblNam" runat="server" Text="Label"></asp:Label><br /><br />
           <div align="center">                
