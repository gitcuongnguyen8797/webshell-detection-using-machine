<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/hcmpcadmin.master" CodeBehind="dsvanban.aspx.vb" Inherits="hcmpc.dsvanban" %>
		...
		<div id="toolbar" class="toolbar-list">
            <ul>
                <li id="toolbar-new" class="button">
                    <a class="toolbar" href="nhapvanban.aspx">
                ...
                <telerik:RadGrid ID="mygrid" runat="server" AutoGenerateColumns="False" GridLines="None"
                    ...
                    <MasterTableView DataKeyNames="VanBan_ID">                
                        <Columns>
                            ...
                            <telerik:GridHyperLinkColumn DataNavigateUrlFormatString="nhapvanban.aspx?ID={0}"
