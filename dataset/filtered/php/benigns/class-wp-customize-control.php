...
class WP_Customize_Control {
	...
	protected function render_content() {
		...
		switch ( $this->type ) {
			case 'checkbox':
				?><?php echo esc_attr( $input_id ); ?><?php echo $describedby_attr; ?><?php echo esc_attr( $this->value() ); ?><?php $this->link(); ?><?php checked( $this->value() ); ?><?php echo esc_attr( $input_id ); ?><?php echo esc_html( $this->label ); ?><?php if ( ! empty( $this->description ) ) : ?><?php echo esc_attr( $description_id ); ?><?php echo $this->description; ?><?php endif; ?><?php
				break;
			case 'radio':
				...
				?><?php if ( ! empty( $this->label ) ) : ?><?php echo esc_html( $this->label ); ?><?php endif; ?><?php if ( ! empty( $this->description ) ) : ?><?php echo esc_attr( $description_id ); ?><?php echo $this->description; ?><?php endif; ?><?php foreach ( $this->choices as $value => $label ) : ?><?php echo esc_attr( $input_id . '-radio-' . $value ); ?><?php echo $describedby_attr; ?><?php echo esc_attr( $value ); ?><?php echo esc_attr( $name ); ?><?php $this->link(); ?><?php checked( $this->value(), $value ); ?><?php echo esc_attr( $input_id . '-radio-' . $value ); ?><?php echo esc_html( $label ); ?><?php endforeach; ?><?php
				break;
			case 'select':
				if ( empty( $this->choices ) ) {
					return;
				...
				?><?php if ( ! empty( $this->label ) ) : ?><?php echo esc_attr( $input_id ); ?><?php echo esc_html( $this->label ); ?><?php endif; ?><?php if ( ! empty( $this->description ) ) : ?><?php echo esc_attr( $description_id ); ?><?php echo $this->description; ?><?php endif; ?><?php echo esc_attr( $input_id ); ?><?php echo $describedby_attr; ?><?php $this->link(); ?><?php
				...
				break;
			case 'textarea':
				?><?php if ( ! empty( $this->label ) ) : ?><?php echo esc_attr( $input_id ); ?><?php echo esc_html( $this->label ); ?><?php endif; ?><?php if ( ! empty( $this->description ) ) : ?><?php echo esc_attr( $description_id ); ?><?php echo $this->description; ?><?php endif; ?><?php echo esc_attr( $input_id ); ?><?php echo $describedby_attr; ?><?php $this->input_attrs(); ?><?php $this->link(); ?><?php echo esc_textarea( $this->value() ); ?><?php
				break;
			case 'dropdown-pages':
				?><?php if ( ! empty( $this->label ) ) : ?><?php echo esc_attr( $input_id ); ?><?php echo esc_html( $this->label ); ?><?php endif; ?><?php if ( ! empty( $this->description ) ) : ?><?php echo esc_attr( $description_id ); ?><?php echo $this->description; ?><?php endif; ?><?php
				...
				echo $dropdown;
				?><?php if ( $this->allow_addition && current_user_can( 'publish_pages' ) && current_user_can( 'edit_theme_options' ) ) : // Currently tied to menus functionality. ?><?php
						/* translators: %s: Add New Page label. */
						printf( __( '+ %s' ), get_post_type_object( 'page' )->labels->add_new_item );
						?><?php echo esc_attr( $this->id ); ?><?php
							/* translators: Hidden accessibility text. */
							_e( 'New page title' );
							?><?php echo esc_attr( $this->id ); ?><?php esc_attr_e( 'New page title&hellip;' ); ?><?php _e( 'Add' ); ?><?php endif; ?><?php
				break;
			default:
				?><?php if ( ! empty( $this->label ) ) : ?><?php echo esc_attr( $input_id ); ?><?php echo esc_html( $this->label ); ?><?php endif; ?><?php if ( ! empty( $this->description ) ) : ?><?php echo esc_attr( $description_id ); ?><?php echo $this->description; ?><?php endif; ?><?php echo esc_attr( $input_id ); ?><?php echo esc_attr( $this->type ); ?><?php echo $describedby_attr; ?><?php $this->input_attrs(); ?><?php if ( ! isset( $this->input_attrs['value'] ) ) : ?><?php echo esc_attr( $this->value() ); ?><?php endif; ?><?php $this->link(); ?><?php
				break;
		}
	}
	...
	final public function print_template() {
		?><?php echo esc_attr( $this->type ); ?><?php $this->content_template(); ?>