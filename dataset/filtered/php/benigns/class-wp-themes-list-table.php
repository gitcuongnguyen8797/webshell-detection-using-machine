...
class WP_Themes_List_Table extends WP_List_Table {
	...
	public function tablenav( $which = 'top' ) {
		...
		?><?php echo $which; ?><?php $this->pagination( $which ); ?><?php
	}
	...
	public function display() {
		...
		?><?php $this->tablenav( 'top' ); ?><?php $this->display_rows_or_placeholder(); ?><?php $this->tablenav( 'bottom' ); ?><?php
	}
	...
	public function display_rows() {
		...
		foreach ( $themes as $theme ) :
			...
			?><?php if ( $screenshot ) : ?><?php echo esc_url( $screenshot . '?ver=' . $theme->version ); ?><?php endif; ?><?php echo wp_customize_url( $stylesheet ); ?><?php if ( $screenshot ) : ?><?php echo esc_url( $screenshot . '?ver=' . $theme->version ); ?><?php endif; ?><?php echo $title; ?><?php
					/* translators: %s: Theme author. */
					printf( __( 'By %s' ), $author );
				?><?php foreach ( $actions as $action ) : ?><?php echo $action; ?><?php endforeach; ?><?php _e( 'Details' ); ?><?php echo $delete_action; ?><?php theme_update_available( $theme ); ?><?php _e( 'Version:' ); ?><?php echo $version; ?><?php echo $theme->display( 'Description' ); ?><?php
				if ( $theme->parent() ) {
					printf(
