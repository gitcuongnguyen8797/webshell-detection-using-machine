...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e) {
        ASPxTextBox1.Enabled = !chbDisabled.Checked;
        
        lblShowError.Enabled = !chbDisabled.Checked;
        chbShowError.Enabled = !chbDisabled.Checked;

        ASPxTextBox1.ValidationSettings.EnableCustomValidation = chbShowError.Checked;
        ASPxTextBox1.IsValid = !chbShowError.Checked;
        
        ASPxTextBox1.Native = chbNative.Checked;
        ASPxTextBox1.RightToLeft = chbRtl.Checked ? DefaultBoolean.True : DefaultBoolean.False;
        RtlContainer.RightToLeft = ASPxTextBox1.RightToLeft;
...
<asp:Content ID="Content2" ContentPlaceHolderID="phComponent" runat="Server">
    <dx:ASPxTextBox ID="ASPxTextBox1" runat="server" Text="Sample Text" Width="170px" ClientInstanceName="tb">
