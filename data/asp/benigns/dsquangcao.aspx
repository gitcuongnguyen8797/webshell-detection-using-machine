<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="dsquangcao.aspx.vb" MasterPageFile="~/hcmpcadmin.master" Inherits="hcmpc.dsquangcao" %>
		...
		<div id="toolbar" class="toolbar-list">
            <ul>
                <li id="toolbar-new" class="button">
                    <a class="toolbar" href="nhapqc.aspx">
			...
			<div class="pagetitle icon-48-article"><h2>Quản lý Quảng cáo: Quảng cáo</h2></div>
		</div>
</div>
    ...
    <div class="m">
        <fieldset id="filter-bar">
		    ...
		    <div class="filter-select fltrt">
			    ...
			    <select onchange="this.form.submit()" class="inputbox" id="filter_type" runat="Server">
				    <option value="">- Chọn loại quảng cáo -</option>
				    <option value="1">Đơn vị thành viên</option>
                    <option value="2">Đơn vị trong ngành</option>
                    <option value="3">Thông tin cần biết</option>
                    <option value="4">Chính sách chất lượng</option>
			    </select>
		    </div>
	    </fieldset>
                ...
                <telerik:RadGrid ID="mygrid" runat="server" AutoGenerateColumns="False" GridLines="None"
                    ...
                    <MasterTableView DataKeyNames="Banner_ID">                
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="Banner_ID" HeaderText="Banner_ID" UniqueName="Banner_ID"
                                Visible="false">
                            </telerik:GridBoundColumn>
                            <telerik:GridHyperLinkColumn DataNavigateUrlFormatString="nhapqc.aspx?ID={0}"
                                DataNavigateUrlFields="Banner_ID" SortExpression="Banner_ID" UniqueName="EditArticle" DataTextField="Name" HeaderText="Tên quảng cáo">
                            ...
                            <telerik:GridBoundColumn DataField="ImageURL" HeaderText="Đường dẫn">    
                                <HeaderStyle Font-Bold="true" />                                                  
                            </telerik:GridBoundColumn>      
                            <telerik:GridBoundColumn DataField="Position" HeaderText="Vị trí">    
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="true" Width="50" />     
                                <ItemStyle HorizontalAlign="Center" />                                              
                            </telerik:GridBoundColumn>              
                            <telerik:GridBoundColumn DataField="Banner_ID" HeaderText="ID" UniqueName="Banner_ID">    
