<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/myniengiam1.Master" CodeBehind="CT_B2.aspx.vb" Inherits="niengiam.CT_B2" %>
      ...
      <div>
          <dx:ASPxGridView ID="ASPxGridView1" runat="server" KeyFieldName="MaDV;Nam;Thang"  AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="100%" Theme="Office2010Blue">
              <Columns>
                  ...
                  <dx:GridViewDataTextColumn FieldName="ThanhPhan" Name="ThanhPhan" VisibleIndex="1" 
                      Caption="Thành phần"  FixedStyle="Left" Width="50px" ReadOnly="True">
