<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="dsmoithau.aspx.vb" MasterPageFile="~/hcmpcadmin.master" Inherits="hcmpc.dsmoithau" %>
		...
		<div id="toolbar" class="toolbar-list">
            <ul>
                <li id="toolbar-new" class="button">
                    <a class="toolbar" href="moithau.aspx">
			...
			<div class="pagetitle icon-48-article"><h2>Quản lý Mời Thầu: Bài viết</h2></div>
		</div>
</div>
                ...
                <telerik:RadGrid ID="mygrid" runat="server" AutoGenerateColumns="False" GridLines="None"
                    ...
                    <MasterTableView DataKeyNames="Article_ID">                
                        <Columns>
                            ...
                            <telerik:GridHyperLinkColumn DataNavigateUrlFormatString="moithau.aspx?ID={0}"
                                DataNavigateUrlFields="Article_ID" SortExpression="Article_ID" UniqueName="EditArticle" DataTextField="DuAn" HeaderText="Dự án">
                            ...
                            <telerik:GridBoundColumn DataField="NoiDung" HeaderText="Nội dung">    
                                <HeaderStyle Font-Bold="true" />                                                  
                            </telerik:GridBoundColumn> 
                             <telerik:GridBoundColumn DataField="TuNgay" DataType="System.DateTime" HeaderText="Từ ngày"
                                SortExpression="TuNgay" DataFormatString="{0:dd/MM/yyyy}" UniqueName="TuNgay">
                                <HeaderStyle Font-Bold="true" HorizontalAlign="Center" Width="100" />
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </telerik:GridBoundColumn>
                             <telerik:GridBoundColumn DataField="DenNgay" DataType="System.DateTime" HeaderText="Đến ngày"
                                SortExpression="DenNgay" DataFormatString="{0:dd/MM/yyyy}" UniqueName="DenNgay">
                                <HeaderStyle Font-Bold="true" HorizontalAlign="Center" Width="100" />
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </telerik:GridBoundColumn>                                 
