...
<div class="yToolbar"> 
  ...
  <div class="TBSep"></div>
  <iframe class="TBGen" style="top:2px" ID="UploadFiles" src="Upload_Article_reply.asp" frameborder=0 scrolling=no width="250" height="25"></iframe>
</div>
...
function pic()
{
  ...
  HtmlEdit.focus();
  var range = HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor_InsertPic_reply.asp", "", "dialogWidth:31em; dialogHeight:17em; help: no; scroll: no; status: no");  
  if (arr != null){
    var ss=arr.split("$$$");
...
function swf()
{
  ...
  HtmlEdit.focus();
  var range = HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor_InsertFlash_reply.asp", "", "dialogWidth:31em; dialogHeight:12em; help: no; scroll: no; status: no"); 
  if (arr != null){
    var ss=arr.split("$$$");
    range.pasteHTML(ss[0]);
    parent.myform.IncludePic.checked=true;
...
function wmv()
{
  ...
  HtmlEdit.focus();
  var range = HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor_InsertMedia_reply.asp", "", "dialogWidth:31em; dialogHeight:12em; help: no; scroll: no; status: no");
  if (arr != null){
    var ss=arr.split("$$$");
    range.pasteHTML(ss[0]);
    parent.myform.IncludePic.checked=true;
...
function rm()
{
  ...
  HtmlEdit.focus();
  var range = HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor_InsertRM_reply.asp", "", "dialogWidth:31em; dialogHeight:12em; help: no; scroll: no; status: no");  
  if (arr != null){
    var ss=arr.split("$$$");
    range.pasteHTML(ss[0]);
    parent.myform.IncludePic.checked=true;
