...
MaxFileSize=rs("uploadsize")        '上传文件大小限制
Const SaveUpFilesPath="uploadreplay"        '存放上传文件的目录
UpFileType=rs("uploadtype")        '允许的上传文件类型
rs.close
set rs=nothing
%>
<!--#include file="upfile_class.asp"-->
<%
const upload_type=0   '上传方法：0=无组件上传类，1=FSO上传 2=lyfupload，3=aspupload，4=chinaaspupload
