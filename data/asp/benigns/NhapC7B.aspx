<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/myniengiam2.Master" CodeBehind="NhapC7B.aspx.vb" Inherits="niengiam.NhapC7B" %>
...
<div class="container">
       ...
       <div>       
           <h1 class="xanh">CÁC CHỈ TIÊU TÀI CHÍNH CHỦ YẾU TOÀN TỔNG CTY ĐIỆN LỰC TP.HCM<br />
           (trong đó chi phí lãi vay và chênh lệch tỉ giá được tính vào Hoạt động tài chính)<br /><br />
           <div align="center">                
