<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="NhapD6.aspx.vb" Inherits="niengiam.NhapD6" MasterPageFile="~/myniengiam2.master"%>
...
<div class="container">
    <div id="system-message-container">            
       ...
       <div>       
           <h1 class="xanh">TÌNH HÌNH TAI NẠN ĐIỆN<br /><br />
           <div align="center">                
           ...
           <div align="right" style="color:#3079ed;font-weight:bold;padding-right:10px;">ĐVT: Vụ</div>
       </div><br />
    <div class="mpanel">            
          <h3>TRONG NHÂN DÂN</h3>
          <asp:table id="tblDynamic1" runat="server" Width="450">
          </asp:table>

         <asp:table id="tblDynamic2" runat="server" Width="450">
         </asp:table>
         <br />
         <h3>TRONG TỔNG CÔNG TY</h3>

         <asp:table id="tblDynamic3" runat="server" Width="450">
         </asp:table>

         <asp:table id="tblDynamic4" runat="server" Width="450">
         </asp:table>       
    </div>
    <div class="bpanel">           
