<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/myniengiam2.master" CodeBehind="NhapA5.aspx.vb" Inherits="niengiam.NhapA5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <div>       
           <h1 class="xanh">ĐIỆN THƯƠNG PHẨM TỪNG THÀNH PHẦN CỦA TỪNG CÔNG TY ĐIỆN LỰC<br /><br />
           <div align="center">                
           ...
           <div align="right" style="color:#3079ed;font-weight:bold;padding-right:10px;">ĐVT: kWh</div>
       </div><br />
       <div class="mpanel">            
