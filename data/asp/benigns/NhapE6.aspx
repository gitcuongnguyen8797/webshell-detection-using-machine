<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="NhapE6.aspx.vb" Inherits="niengiam.NhapE6" MasterPageFile="~/myniengiam2.master"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div class="container">
       ...
       <div>       
           <h1 class="xanh">KHỐI LƯỢNG LƯỚI TRUNG THẾ TỪNG ĐƠN VỊ<br /><br />
           <div align="center">                
           ...
           <div align="right" style="color:#3079ed;font-weight:bold;padding-right:10px;">ĐVT: km</div>
       </div><br />
       <div class="mpanel">            
