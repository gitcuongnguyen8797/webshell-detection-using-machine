...
?><?php
    ...
    $isMainMenu = true;
     ?><?php echo $scriptTitle ?><?php echo buildUrl( sp(2)."<font color=\"navy\"><strong>##Safe0ver##</strong></font>", "cmd=dir&dir=.").sp(2); ?><?php
}

if ($cmd != "downl") {
    if ( $isMainMenu != true) {
         ?><?php echo buildUrl("<font color=\"navy\">[&nbsp;Main Menu&nbsp;]  </font>", "cmd=&dir=");      ?><?php echo buildUrl("<font color=\"navy\">[&nbsp;R00T&nbsp;]  </font>", "cmd=dir&dir=.");  ?><?php
}
