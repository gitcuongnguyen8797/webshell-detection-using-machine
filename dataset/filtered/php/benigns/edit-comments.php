...
?><?php $wp_list_table->views(); ?><?php $wp_list_table->search_box( __( 'Search Comments' ), 'comment' ); ?><?php if ( $post_id ) : ?><?php echo esc_attr( (int) $post_id ); ?><?php endif; ?><?php echo esc_attr( $comment_status ); ?><?php echo esc_attr( current_time( 'mysql', 1 ) ); ?><?php echo esc_attr( $wp_list_table->get_pagination_arg( 'total_items' ) ); ?><?php echo esc_attr( $wp_list_table->get_pagination_arg( 'per_page' ) ); ?><?php echo esc_attr( $wp_list_table->get_pagination_arg( 'page' ) ); ?><?php if ( isset( $_REQUEST['paged'] ) ) { ?><?php echo esc_attr( absint( $_REQUEST['paged'] ) ); ?><?php } ?><?php $wp_list_table->display(); ?><?php
