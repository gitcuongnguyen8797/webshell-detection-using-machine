<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="LeftMenuMaster.master" CodeBehind="dtintucdl.aspx.vb" Inherits="hcmpc.dtintucdl" %>
	...
	<div class="section sectionMain widget-container">
        ...
        <%
          ...
          <li>
					...
					<a href="dtintucdl.aspx?menu=<%=menu%>&ID=<%=r("Article_ID")%>" class="copy" indepth="true">
						<%= r("Title")%>
					</a>
