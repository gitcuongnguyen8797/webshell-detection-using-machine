...
function wp_list_widget_controls( $sidebar, $sidebar_name = '' ) {
	...
	if ( $sidebar_name ) {
		...
		?><?php echo esc_attr( $add_to ); ?><?php echo esc_html( $sidebar_name ); ?><?php echo esc_html( $sidebar_name ); ?><?php
	}
...
function wp_widget_control( $sidebar_args ) {
	...
	?><?php
				...
				?><?php echo esc_url( add_query_arg( $query_arg ) ); ?><?php _ex( 'Edit', 'widget' ); ?><?php _ex( 'Add', 'widget' ); ?><?php echo $widget_title; ?><?php echo $widget_title; ?><?php echo $before_form; ?><?php echo $before_widget_content; ?><?php
	...
	?><?php echo $after_widget_content; ?><?php echo esc_attr( $id_format ); ?><?php echo esc_attr( $id_base ); ?><?php echo esc_attr( $width ); ?><?php echo esc_attr( $height ); ?><?php echo esc_attr( $widget_number ); ?><?php echo esc_attr( $multi_number ); ?><?php echo esc_attr( $add_new ); ?><?php _e( 'Delete' ); ?><?php _e( 'Done' ); ?><?php echo $noform_class; ?><?php submit_button( __( 'Save' ), 'primary widget-control-save right', 'savewidget', false, array( 'id' => 'widget-' . esc_attr( $id_format ) . '-savewidget' ) ); ?><?php echo $after_form; ?><?php
