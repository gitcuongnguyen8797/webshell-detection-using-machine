<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/myniengiam1.master" CodeBehind="4a1.aspx.vb" Inherits="niengiam.BM4a1" %>
...
<br />
<telerik:RadGrid ID="RadGrid1" TabIndex="5" runat="server" DataSourceID="sdsGrid" GridLines="Both" PageSize="25" MasterTableView-Caption="BÁO CÁO CÔNG TÁC BỌC HÓA LƯỚI ĐIỆN" MasterTableView-AlternatingItemStyle-BackColor="White" MasterTableView-ItemStyle-BackColor="#d5ebf9" MasterTableView-EditItemStyle-BackColor="#699ebe"
    ...
    <MasterTableView AllowMultiColumnSorting="True" Width="100%"  CommandItemDisplay="Top"  Font-Bold="False" Font-Italic="False"   DataKeyNames="BM_4a1_Id" EditMode="PopUp" NoMasterRecordsText="Chưa có dữ liệu" >
        <EditFormSettings InsertCaption="Thêm mẫu tin mới" CaptionFormatString="Cập nhật thông tin cho mẫu tin #: {0}"
                CaptionDataField="BM_4a1_Id" PopUpSettings-Modal="true"/>
        ...
        <Columns>
           <telerik:GridEditCommandColumn UniqueName="EditCommandColumn" EditImageUrl="Images\file_edit.png" ButtonType="ImageButton"  EditText="Sửa" HeaderStyle-Width="1%" ItemStyle-Width="1%">
             ...
             <telerik:GridBoundColumn DataField="BM_4a1_Id" DataType="System.Int32" HeaderText="BM_4a1_Id" Display="false" HeaderStyle-Width="0%" ItemStyle-Width="0%" Visible="false"/>            
            <telerik:GridTemplateColumn HeaderText="STT" HeaderStyle-Width="2%" ItemStyle-Width="2%" HeaderButtonType="TextButton"  HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
             ...
             <telerik:GridBoundColumn DataField="ViTriDiemHo" HeaderButtonType="TextButton"  HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left"
                HeaderText="Vị trí điểm hở được bọc kín (vị trí trụ có điểm được bọc)" SortExpression="ViTriDiemHo" UniqueName="ViTriDiemHo" HeaderStyle-Width="25%" ItemStyle-Width="25%" >
            </telerik:GridBoundColumn>
             <telerik:GridBoundColumn DataField="Ten_TuyenDay" HeaderButtonType="TextButton"  HeaderStyle-HorizontalAlign="Center" 
                HeaderText="Tuyến dây" SortExpression="Ten_TuyenDay" UniqueName="Ten_TuyenDay" HeaderStyle-Width="25%" ItemStyle-Width="25%" >
            </telerik:GridBoundColumn>
           ...
           <telerik:GridCheckBoxColumn ColumnGroupName="Loai" DataField="MoiNoi" AllowFiltering="false" AllowSorting="true" ReadOnly="false" HeaderButtonType="TextButton" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
               HeaderText="Kết nối" SortExpression="MoiNoi" UniqueName="MoiNoi" HeaderStyle-Width="5%" ItemStyle-Width="5%">  
           </telerik:GridCheckBoxColumn> 

            <telerik:GridCheckBoxColumn ColumnGroupName="Loai" DataField="TiepXucThietBi" AllowFiltering="false" AllowSorting="true" ReadOnly="false" HeaderButtonType="TextButton" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
               HeaderText="Tiếp xúc thiết bị" SortExpression="TiepXucThietBi" UniqueName="TiepXucThietBi" HeaderStyle-Width="5%" ItemStyle-Width="5%">  
           </telerik:GridCheckBoxColumn>

            <telerik:GridCheckBoxColumn ColumnGroupName="Loai" DataField="Khac" AllowFiltering="false" AllowSorting="true" ReadOnly="false" HeaderButtonType="TextButton" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
               HeaderText="Khác" SortExpression="Khac" UniqueName="Khac" HeaderStyle-Width="5%" ItemStyle-Width="5%">  
           </telerik:GridCheckBoxColumn>
            ...
            <telerik:GridBoundColumn DataField="GhiChu" HeaderButtonType="TextButton" HeaderStyle-HorizontalAlign="Center"
                HeaderText="Ghi chú" SortExpression="GhiChu" UniqueName="GhiChu" HeaderStyle-Width="25%" ItemStyle-Width="25%" >
            </telerik:GridBoundColumn>
        ...
        <EditFormSettings EditFormType="Template" CaptionFormatString="Cập nhật thông tin cho mẫu tin #: {0}" CaptionDataField="BM_4a1_Id" PopUpSettings-ScrollBars="Auto" PopUpSettings-Width="600px" PopUpSettings-Height="450px" FormStyle-BorderWidth="4px">
                <FormTemplate>
                    <table id="Table1" cellspacing="2px" cellpadding="4px" width="100%" border="0px" align="center">
                        <tr>
                         <td>
                            ...
                            <td>
                               <telerik:RadComboBox ID="rcboDonVi2" EnableScreenBoundaryDetection="false" ExpandDirection="Down" Runat="server"  Width="300px" TabIndex="1" DataTextField="TenDonVi" DataValueField="MaDonVi" DataSourceID="sdsDonVi2" SelectedValue='<%# Bind("MaDonVi")%>' OnSelectedIndexChanged ="rcboDonVi2_SelectedIndexChanged" AutoPostBack="true">
                                </telerik:RadComboBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                Vị trí điểm hở được bọc kín (vị trí trụ có điểm được bọc):
                            </td>
                            <td>
                               <telerik:RadTextBox ID="RadTextBox1" Runat="server"  Text='<%# Bind("ViTriDiemHo")%>' MaxLength="4000" Width="95%" TextMode="MultiLine" Rows="5" TabIndex="2">
                               </telerik:RadTextBox>
                            </td>
                            </td>
                         ...
                         <td>
                            ...
                            <td>
                                <telerik:RadComboBox ID="rcboTuyenDay" EnableScreenBoundaryDetection="false" ExpandDirection="Down" Runat="server"  Width="300px" TabIndex="3" DataTextField="Ten_TuyenDay" DataValueField="TuyenDay" DataSourceID="sdsTuyenDay" SelectedValue='<%# DataBinder.Eval(Container.DataItem, "TuyenDay") %>'>
                                </telerik:RadComboBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr >
                            ...
                            <td colspan="6">
                                Loại: 
                               <asp:CheckBox ID="chkMoiNoi" runat="server" Checked='<%# Bind("MoiNoi") %>' Text=' Mối nối' TabIndex="4"></asp:CheckBox>
                                <asp:CheckBox ID="chkTiepXucThietBi" runat="server" Checked='<%# Bind("TiepXucThietBi") %>' Text=' Tiếp xúc thiết bị' TabIndex="5"></asp:CheckBox>
                                <asp:CheckBox ID="chkKhac" Checked='<%# Bind("Khac") %>' runat="server" Text=' Khác' TabIndex="6"></asp:CheckBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6">
                        ...
                        <tr >
                            ...
                            <td >
                               <telerik:RadDateTimePicker ID="rdtpNgayThucHien" Runat="server" Skin="Web20" TabIndex="7"  DbSelectedDate='<%# Bind("NgayThucHien")%>'
                        ...
                        <tr >
                            ...
                            <td >
                               <telerik:RadTextBox ID="RadTextBox4" Runat="server"  Text='<%# Bind("GhiChu")%>' MaxLength="4000" Width="95%" TextMode="MultiLine" Rows="3" TabIndex="8">
                            </telerik:RadTextBox>
                            </td>
                        </tr>
    ...
    <asp:SqlDataSource ID="sdsGrid" runat="server" 
        ...
        SelectCommand="SELECT BM_4a1.*, TenDonVi, (LD.TuyenDay + ' - ' + LD.Ten_TuyenDay) AS Ten_TuyenDay FROM BM_4a1 LEFT JOIN DonVi ON BM_4a1.MaDonVi = DonVi.MaDonVi LEFT JOIN (SELECT DISTINCT TuyenDay, Ten_TuyenDay FROM LuoiDien WHERE DonVi = @MaDonVi) LD ON BM_4a1.TuyenDay = LD.TuyenDay WHERE BM_4a1.MaDonVi = @MaDonVi AND NgayThucHien BETWEEN @TuNgay AND @DenNgay"
        DeleteCommand="DELETE FROM [BM_4a1] WHERE [BM_4a1_Id] = @BM_4a1_Id"
        InsertCommand="INSERT INTO [BM_4a1] ([ViTriDiemHo], [TuyenDay], [MoiNoi], [TiepXucThietBi], [Khac], [GhiChu], [NgayThucHien], [MaDonVi]) 
        VALUES (@ViTriDiemHo, @TuyenDay, @MoiNoi, @TiepXucThietBi, @Khac, @GhiChu, @NgayThucHien, @MaDonVi)"
        UpdateCommand="UPDATE [BM_4a1] SET [ViTriDiemHo] = @ViTriDiemHo, [TuyenDay] = @TuyenDay, [MoiNoi] = @MoiNoi, [TiepXucThietBi] = @TiepXucThietBi, [Khac] = @Khac, [GhiChu] = @GhiChu, [NgayThucHien] = @NgayThucHien, [MaDonVi] = @MaDonVi WHERE [BM_4a1_Id] = @BM_4a1_Id">
        <UpdateParameters>
            <asp:Parameter Name="MaDonVi" Type="String" />
            <asp:Parameter Name="ViTriDiemHo" Type="String" />
            <asp:Parameter Name="TuyenDay" Type="String" />
            <asp:Parameter Name="MoiNoi" Type="Boolean" />
            <asp:Parameter Name="TiepXucThietBi" Type="Boolean" />
            <asp:Parameter Name="Khac" Type="Boolean" />
            <asp:Parameter Name="GhiChu" Type="String" />  
            <asp:Parameter Name="NgayThucHien" Type="DateTime"/>
            <asp:Parameter Name="BM_4a1_Id" Type="Int32" />         
        </UpdateParameters>
        <DeleteParameters>
            <asp:Parameter Name="BM_4a1_Id" Type="Int32" />
        </DeleteParameters>
