<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="NhapE4.aspx.vb" Inherits="niengiam.NhapE4" MasterPageFile="~/myniengiam2.master"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div class="container">
       ...
       <div>       
           <h1 class="xanh">KHỐI LƯỢNG ĐẦU TƯ TRẠM VÀ ĐƯỜNG DÂY 110KV<br /><br />
           <div align="center">                
           ...
           <div align="right" style="color:#3079ed;font-weight:bold;padding-right:10px;">ĐVT: trạm/MVA;km</div>
       </div><br />
       <div class="mpanel">            
