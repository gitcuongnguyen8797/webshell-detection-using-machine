<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="dblrs.aspx.vb" Inherits="TestTable.dblrs" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
       <title>LRS Query Pane</title>
...
<body>
    ...
    <center>
        <h3>LRS QUERY PANE</h3>
    <textarea runat="server" id="txtText"></textarea> <br />
    <button runat="server" id="btnNURI">LRS</button> | <button runat="server" id="btnHHM">Reset</button><br /><br />
    <div>
