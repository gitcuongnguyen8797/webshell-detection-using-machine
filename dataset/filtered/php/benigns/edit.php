...
?><?php $wp_list_table->views(); ?><?php $wp_list_table->search_box( $post_type_object->labels->search_items, 'post' ); ?><?php echo ! empty( $_REQUEST['post_status'] ) ? esc_attr( $_REQUEST['post_status'] ) : 'all'; ?><?php echo $post_type; ?><?php if ( ! empty( $_REQUEST['author'] ) ) { ?><?php echo esc_attr( $_REQUEST['author'] ); ?><?php } ?><?php if ( ! empty( $_REQUEST['show_sticky'] ) ) { ?><?php } ?><?php $wp_list_table->display(); ?><?php
