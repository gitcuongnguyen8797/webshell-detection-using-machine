<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/hcmpcadmin.master" CodeBehind="dspsanh.aspx.vb" Inherits="hcmpc.dspsanh" %>
		...
		<div id="toolbar" class="toolbar-list">
            <ul>
                <li id="toolbar-new" class="button">
                    <a class="toolbar" href="nhappsanh.aspx">
			...
			<div class="pagetitle icon-48-article"><h2>Quản lý PS Ảnh: Bài viết</h2></div>
		</div>
</div>
    ...
    <div class="m">
        <fieldset id="filter-bar">
		    ...
		    <div class="filter-select fltrt">
			    ...
			    <select onchange="this.form.submit()" class="inputbox" id="filter_category_id" runat="Server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <telerik:RadGrid ID="mygrid" runat="server" AutoGenerateColumns="False" GridLines="None"
                    ...
                    <MasterTableView DataKeyNames="Topic_ID">                
                        <Columns>
                            <telerik:GridClientSelectColumn UniqueName="ClientSelectColumn">
                               <HeaderStyle Width="50px" HorizontalAlign="Center" />
                               <ItemStyle HorizontalAlign="Center" />
                           </telerik:GridClientSelectColumn>
                            <telerik:GridBoundColumn DataField="Topic_ID" HeaderText="Topic_ID" UniqueName="Topic_ID"
                                Visible="false">
                            </telerik:GridBoundColumn>
                            <telerik:GridHyperLinkColumn DataNavigateUrlFormatString="nhappsanh.aspx?ID={0}"
                                DataNavigateUrlFields="Topic_ID" SortExpression="Topic_ID" UniqueName="EditArticle" DataTextField="Title" HeaderText="Tiêu Đề">
                            ...
                            <telerik:GridBoundColumn DataField="Topic_ID" HeaderText="ID" UniqueName="Topic_ID">    
                                <HeaderStyle Font-Bold="true" HorizontalAlign="Center" Width="100" />                           
                                <ItemStyle HorizontalAlign="Center" />
                            </telerik:GridBoundColumn>
                        </Columns>
