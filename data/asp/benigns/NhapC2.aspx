<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="NhapC2.aspx.vb" Inherits="niengiam.NhapC2" MasterPageFile="~/myniengiam2.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <div class="container">
       ...
       <div>       
           <h1 class="xanh">GIÁ BÁN ĐIỆN BÌNH QUÂN TỪNG ĐƠN VỊ (CHƯA CÓ VAT)<br /><br />
           <div align="center">                
           ...
           <div align="right" style="color:#3079ed;font-weight:bold;padding-right:10px;">ĐVT: đ/kWh</div>
       </div><br />
       <div class="mpanel">            
