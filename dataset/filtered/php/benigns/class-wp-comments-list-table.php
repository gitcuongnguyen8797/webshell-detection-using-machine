...
class WP_Comments_List_Table extends WP_List_Table {
	...
	public function display() {
		...
		?><?php echo implode( ' ', $this->get_table_classes() ); ?><?php $this->print_column_headers(); ?><?php $this->display_rows_or_placeholder(); ?><?php
			/*
			...
			$this->items = $items;
		?><?php $this->print_column_headers( false ); ?><?php
	...
	public function column_cb( $item ) {
		...
		if ( $this->user_can ) {
			...
			/* translators: Hidden accessibility text. */
			_e( 'Select comment' );
			?><?php echo $comment->comment_ID; ?><?php echo $comment->comment_ID; ?><?php
		}
	}
	...
	public function column_comment( $comment ) {
		...
		if ( $this->user_can ) {
			...
			?><?php echo $comment->comment_ID; ?><?php echo esc_textarea( $comment_content ); ?><?php echo esc_html( $comment->comment_author_email ); ?><?php echo esc_html( $comment->comment_author ); ?><?php echo esc_url( $comment->comment_author_url ); ?><?php echo $comment->comment_approved; ?>