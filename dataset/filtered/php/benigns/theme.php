	...
	?><?php
					...
					?><?php _e( 'Active Theme' ); ?><?php
						...
						?><?php
								...
								?><?php _e( 'Update Available' ); ?><?php _e( 'Update Incompatible' ); ?><?php
										printf(
											/* translators: %s: Theme name. */
						...
						?><?php
							...
							?><?php _e( 'Tags:' ); ?><?php _e( 'Customize' ); ?><?php if ( current_user_can( 'delete_themes' ) ) { ?><?php _e( 'Delete' ); ?><?php } ?><?php
							/* translators: %s: Theme name. */
							$aria_label = sprintf( _x( 'Activate %s', 'theme' ), '{{ data.name }}' );
						?><?php echo esc_attr( $aria_label ); ?><?php _e( 'Activate' ); ?><?php _e( 'Live Preview' ); ?><?php _e( 'Live Preview' ); ?><?php _e( 'Install' ); ?><?php _e( 'Install &amp; Preview' ); ?><?php _ex( 'Cannot Install', 'theme' ); ?><?php _e( 'Install &amp; Preview' ); ?>