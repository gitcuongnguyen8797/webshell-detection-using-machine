<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/myniengiam2.Master" CodeBehind="NhapE5.aspx.vb" Inherits="niengiam.NhapE5" %>
...
<div class="container">
       ...
       <div>       
           <h1 class="xanh">KHỐI LƯỢNG TRẠM HẠ THẾ TỪNG ĐƠN VỊ<br /><br />
           <div align="center">                
           ...
           <div align="right" style="color:#3079ed;font-weight:bold;padding-right:10px;">ĐVT: trạm;kVA</div>
       </div><br />
       <div class="mpanel">            
