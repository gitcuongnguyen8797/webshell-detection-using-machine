...
class WP_Terms_List_Table extends WP_List_Table {
	...
	public function inline_edit() {
		...
		?><?php echo $this->get_column_count(); ?><?php _e( 'Quick Edit' ); ?><?php _ex( 'Name', 'term name' ); ?><?php _e( 'Slug' ); ?><?php
			$core_columns = array(
				'cb'          => true,
				'description' => true,
				'name'        => true,
			...
			?><?php echo $tax->labels->update_item; ?><?php _e( 'Cancel' ); ?><?php wp_nonce_field( 'taxinlineeditnonce', '_inline_edit', false ); ?><?php echo esc_attr( $this->screen->taxonomy ); ?><?php echo esc_attr( $this->screen->post_type ); ?>