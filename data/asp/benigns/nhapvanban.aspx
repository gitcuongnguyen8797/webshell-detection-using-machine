<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/hcmpcadmin.master" CodeBehind="nhapvanban.aspx.vb" Inherits="hcmpc.nhapvanban" %>
	...
	<div class="m">
		<div id="toolbar" class="toolbar-list">
            ...
            <div class="clr"></div>
					...
					<div class="pagetitle icon-48-article-add"><h2>Quản lý Pháp chế: <%= IIf(Request("ID") = "", "Pháp chế mới", "Chỉnh sửa Pháp chế")%></h2></div>
			</div>
</div>
    ...
    <div class="m">
        <table border="0" width="100%" cellspacing="5"> 
         <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="cboNhomVanBan" AutoPostBack="true" Runat="server" Width="300"></telerik:RadComboBox>          
                </td>
            </tr> 
            <tr>
                <td width="100">
                ...
                <td>
                    <telerik:RadComboBox ID="cboLoaiVanBan" Runat="server" Width="300"></telerik:RadComboBox>          
                </td>
            </tr>                       
            <tr>
                <td>
