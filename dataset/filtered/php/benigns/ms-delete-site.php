...
###SITEURL###"
	...
	?><?php _e( 'Thank you. Please check your email for a link to confirm your action. Your site will not be deleted until this link is clicked.' ); ?><?php
} else {
	?><?php
		printf(
			/* translators: %s: Network title. */
	...
	?><?php _e( 'Remember, once deleted your site cannot be restored.' ); ?><?php wp_nonce_field( 'delete-blog' ); ?><?php
			printf(
