...
class WP_Admin_Bar {
	...
	final protected function _render( $root ) {
		...
		?><?php echo $class; ?><?php if ( ! is_admin() && ! did_action( 'wp_body_open' ) ) { ?><?php _e( 'Skip to toolbar' ); ?><?php } ?><?php esc_attr_e( 'Toolbar' ); ?><?php
				foreach ( $root->children as $group ) {
					$this->_render_group( $group );
				}
				?><?php if ( is_user_logged_in() ) : ?><?php echo esc_url( wp_logout_url() ); ?><?php _e( 'Log Out' ); ?><?php endif; ?>