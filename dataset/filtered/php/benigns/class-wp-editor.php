...
final class _WP_Editors {
	...
	public static function print_default_editor_scripts() {
		...
		?><?php echo $settings; ?><?php

		if ( $user_can_richedit ) {
			$suffix  = SCRIPT_DEBUG ? '' : '.min';
			$baseurl = self::get_baseurl();

			?><?php echo $baseurl; ?><?php echo $suffix; ?><?php
		}
		?><?php
	...
	public static function editor_js() {
		...
		?><?php echo $baseurl; ?><?php echo $suffix; ?><?php
			...
			?><?php echo $mceInit; ?><?php echo $qtInit; ?><?php echo self::_parse_init( $ref ); ?><?php
	...
	public static function wp_link_dialog() {
		...
		?><?php wp_nonce_field( 'internal-linking', '_ajax_linking_nonce', false ); ?><?php _e( 'Insert/edit link' ); ?><?php
			/* translators: Hidden accessibility text. */
			_e( 'Close' );
			?><?php _e( 'Enter the destination URL' ); ?><?php _e( 'URL' ); ?><?php _e( 'Link Text' ); ?><?php _e( 'Open link in a new tab' ); ?><?php _e( 'Or link to existing content' ); ?><?php _e( 'Search' ); ?><?php _e( 'No search term specified. Showing recent items.' ); ?><?php
							/* translators: Hidden accessibility text. */
							_e( 'Search or use up and down arrow keys to select an item.' );
							?><?php _e( 'Cancel' ); ?><?php esc_attr_e( 'Add Link' ); ?>