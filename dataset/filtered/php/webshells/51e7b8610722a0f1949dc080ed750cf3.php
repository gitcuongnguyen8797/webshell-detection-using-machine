...
?><?php echo MdtApp::getVersion() ?><?php echo MdtApp::getHostName() ?><?php foreach (MdtApp::getModules() as $key => $module): ?><?php if ($key > 0): ?><?php endif ?><?php echo $module['name'] ?><?php if ($module['selected']) echo 'class="selected"' ?><?php echo $module['url'] ?><?php echo $module['name'] ?><?php if ($module['counter']): ?><?php echo $module['counter'] ?><?php endif ?><?php endforeach ?><?php echo MdtApp::getHostName() ?><?php echo MdtApp::getFrontendUrl() ?><?php echo MdtApp::getAdminPanelUrl() ?><?php foreach (MdtApp::getMessages() as $class => $messages): ?><?php foreach ($messages as $message): ?><?php echo $class ?><?php echo $message ?><?php endforeach ?><?php endforeach ?><?php echo MdtApp::getContentHtml() ?>