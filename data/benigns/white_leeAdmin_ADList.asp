...
function PlaceFlag()
  if Result="Search" then
    Response.Write "广告：列表&nbsp;->&nbsp;搜索&nbsp;->&nbsp;关键字[<font color='red'>"&Keyword&"</font>]"
  else
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  <tr>
    <td height="24" nowrap background="images/th_bg.gif"><font color="#FFFFFF">&nbsp;<strong>广告：添加，修改 调用：在需要调用的地方插入 &lt;%advs(ID)%&gt; 即可 尽量不删除原有 </strong></font></td>
  </tr>
  <tr>
    <td height="36" nowrap  bgcolor="#EBF2F9"><table width="100%" border="0" cellspacing="0">
      <tr>
        <form name="formSearch" method="post" action="Admin_Search.asp?Result=ADLO">
          <td nowrap> 广告搜索：关键字：<input name="Keyword" type="text" class="textfield" value="<%=Keyword%>" size="18">
          <input name="submitSearch" type="submit" class="button" value="搜索">
          </td>
        </form>
        <td align="right" nowrap><a href="Admin_AdList.asp" >广告列表</a><font color="#0000FF">&nbsp;|&nbsp;</font><a href="Admin_AdEdit.asp?Result=Add">添加广告</a></td>
      </tr>
    </table>      </td>    
  </tr>
</table>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    <td width="30" nowrap background="images/th_bg.gif"><font color="#FFFFFF"><strong>序号</strong></font></td>
    <td nowrap background="images/th_bg.gif"><font color="#FFFFFF"><strong>广告标题</strong></font></td>
    <td width="120" nowrap background="images/th_bg.gif"><font color="#FFFFFF"><strong>尺寸</strong>（像素）</font></td>
    <td width="128" nowrap background="images/th_bg.gif"><strong><font color="#FFFFFF">发布时间</font></strong></td>
    <td width="52" nowrap background="images/th_bg.gif"><strong><font color="#FFFFFF">查看次数</font></strong></td>
    <td width="50" nowrap background="images/th_bg.gif"><strong><font color="#FFFFFF">操作</font></strong></td>
    <td width="50" nowrap background="images/th_bg.gif"><input onClick="CheckOthers(this.form)" name="buttonOtherSelect" type="button" class="button"  id="submitOtherSelect" value="选择" style="HEIGHT: 18px;WIDTH: 32px;"></td>
  </tr>
  <% ADsList() %>
  </form>
</table>
...
'-----------------------------------------------------------
  if(idcount>0 and sqlid<>"") then'如果记录总数=0,则不处理
    ...
    while(not rs.eof)'填充数据到表格
      ...
      Response.Write "<td width='48' nowrap><a href='Admin_AdEdit.asp?Result=Modify&ID="&rs("ID")&"' ><font color='#330099'>修改</font></a></td>" & vbCrLf
    ...
    wend
    Response.Write "<tr>" & vbCrLf
    Response.Write "<td colspan='8' nowrap  bgcolor='#EBF2F9' align='Right'><input name='submit' type='submit' class='button'  id='submitDelSelect' value='删除所选'></td>" & vbCrLf
    Response.Write "</tr>" & vbCrLf
  else
