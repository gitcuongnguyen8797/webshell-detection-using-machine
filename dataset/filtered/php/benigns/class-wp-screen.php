...
final class WP_Screen {
	...
	public function render_screen_meta() {
		...
		// Time to render!
		?><?php echo esc_attr( $help_class ); ?><?php esc_attr_e( 'Contextual Help Tab' ); ?><?php
						$class = ' class="active"';
						foreach ( $this->get_help_tabs() as $tab ) :
							$link_id  = "tab-link-{$tab['id']}";
							$panel_id = "tab-panel-{$tab['id']}";
							?><?php echo esc_attr( $link_id ); ?><?php echo $class; ?><?php echo esc_url( "#$panel_id" ); ?><?php echo esc_attr( $panel_id ); ?><?php echo esc_html( $tab['title'] ); ?><?php
							$class = '';
						endforeach;
						?><?php if ( $help_sidebar ) : ?><?php echo $help_sidebar; ?><?php endif; ?><?php
						$classes = 'help-tab-content active';
						foreach ( $this->get_help_tabs() as $tab ) :
							$panel_id = "tab-panel-{$tab['id']}";
							?><?php echo esc_attr( $panel_id ); ?><?php echo $classes; ?><?php
								// Print tab content.
								echo $tab['content'];
		...
		?><?php if ( $this->show_screen_options() ) : ?><?php _e( 'Screen Options' ); ?><?php
		endif;
		if ( $this->get_help_tabs() ) :
			?><?php _e( 'Help' ); ?><?php endif; ?><?php
	}
	...
	public function render_meta_boxes_preferences() {
		...
		?><?php _e( 'Screen elements' ); ?><?php _e( 'Some screen elements can be shown or hidden by using the checkboxes.' ); ?><?php _e( 'Expand or collapse the elements by clicking on their headings, and arrange them by dragging their headings or by clicking on the up and down arrows.' ); ?><?php
	...
	public function render_screen_layout() {
		...
		?><?php _e( 'Layout' ); ?><?php for ( $i = 1; $i <= $num; ++$i ) : ?><?php echo $i; ?><?php echo esc_attr( $i ); ?><?php checked( $screen_layout_columns, $i ); ?><?php
				printf(
	...
	public function render_per_page_options() {
		...
		?><?php _e( 'Pagination' ); ?><?php if ( $per_page_label ) : ?><?php echo esc_attr( $option ); ?><?php echo $per_page_label; ?><?php echo esc_attr( $option ); ?><?php echo esc_attr( $per_page ); ?><?php endif; ?><?php echo esc_attr( $option ); ?><?php
	}
	...
	public function render_view_mode() {
		...
		// This needs a submit button.
		add_filter( 'screen_options_show_submit', '__return_true' );
		?><?php _e( 'View mode' ); ?><?php checked( 'list', $mode ); ?><?php _e( 'Compact view' ); ?><?php checked( 'excerpt', $mode ); ?><?php _e( 'Extended view' ); ?>