...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e) {
        ...
        RtlContainer.RightToLeft = ASPxGridLookup1.RightToLeft;
        ...
        ASPxGridLookup1.GridView.SettingsPager.RenderMode = (ControlRenderMode)Enum.Parse(typeof(ControlRenderMode),
        ...
        (ASPxGridLookup1.Columns["CommandColumn"] as GridViewCommandColumn).ButtonType =
...
<asp:Content ID="Content2" ContentPlaceHolderID="phComponent" runat="Server">
    <div style="width: 804px">
        <dx:ASPxGridLookup ID="ASPxGridLookup1" runat="server" AutoGenerateColumns="False"
            ...
            TextFormatString="{1}">
            <ClientSideEvents Init="function(s, e) { new ASPxGridLookupPreviewHelper(s); }" />
            <Columns>
