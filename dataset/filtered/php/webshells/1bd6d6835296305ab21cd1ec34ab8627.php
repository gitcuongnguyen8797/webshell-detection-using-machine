...
?><?php
  ...
  ?><?php echo $username
  ?><?php } else { /* Auth'd */ ?><?php echo $_SERVER['SERVER_ADDR']; ?><?php echo htmlspecialchars($_SERVER['SERVER_NAME']); ?><?php if (empty($_SERVER['HTTP_X_FORWARDED_FOR'])) { echo htmlspecialchars($_SERVER['REMOTE_ADDR']); } else { echo htmlspecialchars($_SERVER['HTTP_X_FORWARDED_FOR']); } ?><?php echo htmlspecialchars($_SERVER['SERVER_SOFTWARE']); ?><?php echo htmlspecialchars($_SERVER['HTTP_USER_AGENT']); ?><?php echo htmlspecialchars($_SESSION['cwd'], ENT_COMPAT, 'UTF-8'); ?><?php echo htmlspecialchars($_SERVER['SERVER_SIGNATURE'])?><?php echo $columns ?><?php echo $rows ?><?php
$lines = substr_count($_SESSION['output'], "\n");
$padding = str_repeat("\n", max(0, $rows+1 - $lines));
echo rtrim($padding . $_SESSION['output']);
?><?php echo $columns-2 ?><?php echo $rows ?><?php echo $columns
  ?><?php } ?>