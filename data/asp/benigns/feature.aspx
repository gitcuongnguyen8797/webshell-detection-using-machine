<%@ Page Language="vb" AutoEventWireup="false" EnableEventValidation="true" MasterPageFile="~/hcmpcadmin.master" CodeBehind="feature.aspx.vb" Inherits="hcmpc.feature" %>
	...
	<div class="m">
		<div id="toolbar" class="toolbar-list">
            <ul>
                ...
                <a class="toolbar" onclick="if (!isBoxChecked()){alert('Vui lòng chọn dữ liệu không nổi bật');}else{ __doPostBack('<%= btnFeature.UniqueID %>','')}" href="#">
			...
			<div class="pagetitle icon-48-featured"><h2>Quản lý bài viết: Bài viết nổi bật</h2></div>
		</div>
</div>
