<%@ Page Language="vb" title="Nhập liệu Mẫu 2.1 SVNLĐ" MasterPageFile="~/siteadmin.master" AutoEventWireup="false" CodeBehind="giadien_mau2_1.aspx.vb" Inherits="bckinhdoanh.giadien_mau2_1" %>
 ...
 collapse;width:415pt" width="550">
        ...
        <tr height="43">
            <td class="xl72" colspan="4" height="43" width="550">
               <br /><br /> QUẢN LÝ GIÁ ĐIỆN CHO CN, SV, NLĐ THUÊ THỐNG NHẤT VỚI ĐỊA PHƯƠNG</td>
        </tr>
        <tr height="21">
        ...
        <tr height="33">
            <td class="xl70" height="33" width="110">
                <asp:TextBox ID="txtSoChu" runat="server" width="90"></asp:TextBox></td>
            <td class="xl70" width="110">
                <asp:TextBox ID="txtSoPhong" runat="server" width="90"></asp:TextBox>
            </td>
            <td class="xl70" width="110">
                <asp:TextBox ID="txtSoNguoi" runat="server" width="90"></asp:TextBox></td>
            <td class="xl70" width="110">
