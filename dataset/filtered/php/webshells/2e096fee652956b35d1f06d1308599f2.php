...
?><?php echo($self); ?><?php echo(session_id()); ?><?php echo(htmlentities($_GET['symlinktarget'])); ?><?php echo(htmlentities($_SERVER['SERVER_NAME'])); ?><?php echo(htmlentities($_SERVER['SERVER_SOFTWARE'])); ?><?php echo($words['target']); ?><?php echo(htmlentities($_GET['symlinktarget'])); ?><?php echo($words['reltarget']); ?><?php echo($words['symlink']); ?><?php echo(htmlentities(spath(dirname($symlinktarget)))); ?><?php $size = strlen($_GET['symlinktarget']) + 9; if ($size < 30) $size = 30; echo($size);  ?><?php echo($words['create']); ?><?php
	html_footer();
	exit;
}
...
?><?php echo(htmlentities($_SERVER['SERVER_NAME'])); ?><?php echo(htmlentities($_SERVER['SERVER_SOFTWARE'])); ?><?php echo(buildphrase('&quot;<b>' . htmlentities($delete) . '</b>&quot;', $words['suredelete'])); ?><?php echo("$self?" . SID . '&delete=' . urlencode($delete) . '&sure=TRUE'); ?><?php echo($words['yes']); ?><?php
		html_footer();
		exit;
	}
}
...
?><?php echo($self); ?><?php echo(session_id()); ?><?php echo(htmlentities($_SERVER['SERVER_NAME'])); ?><?php echo(htmlentities($_SERVER['SERVER_SOFTWARE'])); ?><?php echo($words['file']); ?><?php echo(htmlentities($permission)); ?><?php echo(textfieldsize($permission)); ?><?php echo($words['change']); ?><?php echo($words['permission']); ?><?php echo($self); ?><?php echo(session_id()); ?><?php echo(htmlentities($permission)); ?><?php echo($words['owner']); ?><?php echo($words['group']); ?><?php echo($words['other']); ?><?php echo($words['read']); ?><?php if ($p & 00400) echo(' checked'); ?><?php if ($p & 00040) echo(' checked'); ?><?php if ($p & 00004) echo(' checked'); ?><?php echo($words['write']); ?><?php if ($p & 00200) echo(' checked'); ?><?php if ($p & 00020) echo(' checked'); ?><?php if ($p & 00002) echo(' checked'); ?><?php echo($words['exec']); ?><?php if ($p & 00100) echo(' checked'); ?><?php if ($p & 00010) echo(' checked'); ?><?php if ($p & 00001) echo(' checked'); ?><?php echo($words['setperms']); ?><?php
			html_footer();
			exit;
		}
	} else {
...
?><?php echo($self); ?><?php echo(session_id()); ?><?php echo(htmlentities($move)); ?><?php echo(htmlentities($_SERVER['SERVER_NAME'])); ?><?php echo(htmlentities($_SERVER['SERVER_SOFTWARE'])); ?><?php echo($words['file']); ?><?php echo(htmlentities($move)); ?><?php echo($words['moveto']); ?><?php echo(htmlentities(spath(dirname($move)))); ?><?php echo(textfieldsize($move)); ?><?php echo($words['move']); ?><?php
		html_footer();
		exit;
	}
}
...
?><?php echo($self); ?><?php echo(session_id()); ?><?php echo(htmlentities($copy)); ?><?php echo(htmlentities($_SERVER['SERVER_NAME'])); ?><?php echo(htmlentities($_SERVER['SERVER_SOFTWARE'])); ?><?php echo($words['file']); ?><?php echo(htmlentities($copy)); ?><?php echo($words['copyto']); ?><?php echo(htmlentities(spath(dirname($copy)))); ?><?php echo(textfieldsize($copy)); ?><?php echo($words['copy']); ?><?php
		html_footer();
		exit;
	}
}
...
?><?php echo($self); ?><?php echo(session_id()); ?><?php echo(htmlentities($_SERVER['SERVER_NAME'])); ?><?php echo(htmlentities($_SERVER['SERVER_SOFTWARE'])); ?><?php echo($words['file']); ?><?php echo(htmlentities($file)); ?><?php echo(textfieldsize($file)); ?><?php echo($words['change']); ?><?php echo($self); ?><?php echo(session_id()); ?><?php echo(htmlentities($file)); ?><?php echo($editrows); ?><?php echo($editcols); ?><?php
			...
			fclose($f);
?><?php if (basename($file) == '.htpasswd') { /* specials with .htpasswd */ ?><?php echo($words['username']); ?><?php echo($words['password']); ?><?php echo($words['add']); ?><?php } if (basename($file) == '.htaccess') { /* specials with .htaccess */ ?><?php echo($words['addauth']); ?><?php } ?><?php echo($words['reset']); ?><?php echo($words['clear']); ?><?php echo($words['save']); ?><?php
			html_footer();
			exit;
		} else {
...
?><?php echo(htmlentities($_SERVER['SERVER_NAME'])); ?><?php echo(htmlentities($_SERVER['SERVER_SOFTWARE'])); ?><?php echo(buildphrase('&quot;<b>' . htmlentities($file) . '</b>&quot;', $words['overwrite'])); ?><?php echo("{$_SERVER['REQUEST_URI']}&overwrite=yes"); ?><?php echo($words['yes']); ?><?php
		html_footer();
		exit;
	}
...
?><?php if ($dirchanged) echo(" '$self?noupdate=TRUE&dir=" . urlencode($_SESSION['dir']) . '&' . SID . '&pmru=' . time() . "'))\""); ?><?php
...
function frameset () {
	global $self;
?><?php echo($self); ?><?php echo("$self?frame=treeview&" . SID . '#' . urlencode($_SESSION['dir'])); ?><?php echo("$self?" . SID); ?><?php
	return;
}
...
?><?php echo($self); ?><?php echo(session_id()); ?><?php echo(htmlentities($_SERVER['SERVER_NAME'])); ?><?php echo(htmlentities($_SERVER['SERVER_SOFTWARE'])); ?><?php echo("<a href=\"$self?dir=" . urlencode($homedir) . "$p\">" . $words['dir']); ?><?php echo(htmlentities($_SESSION['dir'])); ?><?php echo(textfieldsize($_SESSION['dir'])); ?><?php echo($words['change']); ?><?php if (@is_writable($_SESSION['dir'])) { ?><?php echo($self); ?><?php echo(htmlentities($_SESSION['dir'])); ?><?php echo(session_id()); ?><?php if (isset($_REQUEST['frame'])) { ?><?php echo($_REQUEST['frame']); ?><?php } ?><?php echo($words['file']); ?><?php echo($words['upload']); ?><?php echo($self); ?><?php echo(htmlentities($_SESSION['dir'])); ?><?php echo(session_id()); ?><?php if (isset($_REQUEST['frame'])) { ?><?php echo($_REQUEST['frame']); ?><?php } ?><?php echo($words['file']); ?><?php echo($words['dir']); ?><?php echo($words['create']); ?><?php
	}
...
?><?php echo("$self - $action"); ?><?php
	if (isset($_REQUEST['edit']) && !isset($_POST['save']) && basename($edit = $_REQUEST['edit']) == '.htaccess') {
		$file = dirname($edit) . '/.htpasswd';
?><?php echo(htmlentities($file)); ?><?php
	}
?><?php if ($updatetreeview && !empty($_SESSION['tree'])) echo(" '$self?frame=treeview&dir=" . urlencode($_SESSION['dir']) . '&' . SID . '&pmru=' . time() . '#' . urlencode($_SESSION['dir']) . "'))\""); ?><?php
...
function html_footer ($backbutton = TRUE) {
	global $self, $words;
	if ($backbutton) {
?><?php echo("$self?id=". $_REQUEST['id']); ?><?php echo($words['back']); ?><?php
	}
?><?php
	return;
}
