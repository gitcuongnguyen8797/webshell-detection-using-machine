...
?><?php echo $ver; ?><?php print "$site?$kverya"; ?><?php print $my_keyw; ?><?php print $dira; ?><?php print $my_keyw; ?><?php print 'Server: ';
print U_sapi();
...
?><?php print "$site?$kverya"; ?><?php print $dira; ?><?php print $my_keyw; ?><?php
show_cwd($dira);
?><?php print "$site?$kverya"; ?><?php print $dira; ?><?php print $my_keyw; ?><?php print $page; ?><?php print "$site?$kverya"; ?><?php print $dira; ?><?php print $page; ?><?php print $my_keyw; ?><?php print "$site?$kverya"; ?><?php print $page; ?><?php print $dira; ?><?php print $my_keyw; ?><?php print $dira; ?><?php
...
{
?><?php print "$site?$kverya"; ?><?php print $page; ?><?php print $dira; ?><?php print $my_keyw; ?><?php print $edit; ?><?php
