...
class WP_List_Table {
	...
	public function search_box( $text, $input_id ) {
		...
		?><?php echo esc_attr( $input_id ); ?><?php echo $text; ?><?php echo esc_attr( $input_id ); ?><?php _admin_search_query(); ?><?php submit_button( $text, '', '', false, array( 'id' => 'search-submit' ) ); ?><?php
	}
	...
	protected function months_dropdown( $post_type ) {
		...
		?><?php echo get_post_type_object( $post_type )->labels->filter_by_date; ?><?php selected( $m, 0 ); ?><?php _e( 'All dates' ); ?><?php
	...
	protected function view_switcher( $current_mode ) {
		?><?php echo esc_attr( $current_mode ); ?><?php
	...
	public function display() {
		...
		?><?php echo implode( ' ', $this->get_table_classes() ); ?><?php $this->print_column_headers(); ?><?php
		if ( $singular ) {
			echo " data-wp-lists='list:$singular'";
		}
		?><?php $this->display_rows_or_placeholder(); ?><?php $this->print_column_headers( false ); ?><?php
	...
	protected function display_tablenav( $which ) {
		...
		?><?php echo esc_attr( $which ); ?><?php if ( $this->has_items() ) : ?><?php $this->bulk_actions( $which ); ?><?php
		endif;
