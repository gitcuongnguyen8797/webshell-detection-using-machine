<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/hcmpcadmin.master" CodeBehind="nhapcategory.aspx.vb" Inherits="hcmpc.nhapcategory" %>
	...
	<div class="m">
		<div id="toolbar" class="toolbar-list">
            <ul>
                ...
                <a class="toolbar" href="dscategory.aspx">
            ...
            <div class="clr"></div>
					...
					<div class="pagetitle icon-48-article-add"><h2>Quản lý thể loại: <%=IIf(Request("ID") = "", "Thêm thể loại mới", "Chỉnh sửa thể loại")%></h2></div>
			</div>
</div>
...
<table border="0" width="100%" cellspacing="5">   
    <tr>
        ...
        <td>
            <telerik:RadComboBox ID="cboMenu" Runat="server" Width="300"></telerik:RadComboBox>          
        </td>
    </tr>
    <tr>
        <td>
