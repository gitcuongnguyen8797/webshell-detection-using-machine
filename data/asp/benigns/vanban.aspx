<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="casefour.master" CodeBehind="vanban.aspx.vb" Inherits="hcmpc.vanban" %>
...
<div id="recentNews">
    ...
    <tr>
        ...
        <td > 
            <div>
         <a class="pdf" href="<%=tt("FileUpload")%>">
