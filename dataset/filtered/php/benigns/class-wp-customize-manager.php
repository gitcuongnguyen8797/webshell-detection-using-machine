...
final class WP_Customize_Manager {
	...
	protected function wp_die( $ajax_message, $message = null ) {
		...
		if ( $this->messenger_channel ) {
			...
			?><?php echo wp_json_encode( $settings ); ?><?php
	...
	public function render_control_templates() {
		...
		?><?php
						...
						?><?php
							...
							?><?php _e( 'Go back' ); ?><?php _e( 'Preview' ); ?><?php _e( 'Take over' ); ?><?php _e( 'Update anyway, even though it might break your site?' ); ?><?php
		/* The following template is obsolete in core but retained for plugins. */
		?><?php esc_html_e( 'Share Preview Link' ); ?><?php esc_html_e( 'See how changes would look live on your website, and share the preview with people who can\'t access the Customizer.' ); ?><?php
					/* translators: Hidden accessibility text. */
					esc_html_e( 'Preview Link' );
					?><?php
						/* translators: Hidden accessibility text. */
						_e( '(opens in a new tab)' );
						?><?php esc_attr_e( 'Copy' ); ?><?php esc_attr_e( 'Copied' ); ?><?php esc_html_e( 'Copy' ); ?><?php
	}
