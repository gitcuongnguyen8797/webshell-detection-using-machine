<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/hcmpcadmin.master" CodeBehind="dssection.aspx.vb" Inherits="hcmpc.dssection" EnableEventValidation="true" %>
		...
		<div id="toolbar" class="toolbar-list">
            <ul>
                <li id="toolbar-new" class="button">
                    <a class="toolbar" href="nhapsection.aspx">
			...
			<div class="pagetitle icon-48-article"><h2>Quản lý danh mục: Danh mục</h2></div>
		</div>
</div>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <telerik:RadGrid ID="mygrid" runat="server" AutoGenerateColumns="False" GridLines="None"
                    ...
                    <MasterTableView DataKeyNames="Section_ID">     
                        <Columns>            
                            <telerik:GridClientSelectColumn UniqueName="ClientSelectColumn">
                               <HeaderStyle Width="50px" HorizontalAlign="Center" />
                               <ItemStyle HorizontalAlign="Center" />
                           </telerik:GridClientSelectColumn>
                            <telerik:GridBoundColumn DataField="Section_ID" HeaderText="Section_ID" UniqueName="Section_ID"
                                Visible="false">
                            </telerik:GridBoundColumn>    
                            <telerik:GridHyperLinkColumn DataNavigateUrlFormatString="nhapsection.aspx?ID={0}"
                                DataNavigateUrlFields="Section_ID" SortExpression="Section_ID" UniqueName="EditSection" DataTextField="Title" HeaderText="Tiêu Đề">
                           ...
                           <telerik:GridButtonColumn CommandName="DuyetSection" DataTextField="HienThi" Text="DuyetSection"
                             ...
                             <telerik:GridBoundColumn DataField="Section_ID" HeaderText="ID" UniqueName="Section_ID">    
                                <HeaderStyle Font-Bold="true" HorizontalAlign="Center" Width="100" />                           
                                <ItemStyle HorizontalAlign="Center" />
                            </telerik:GridBoundColumn>
                        </Columns>
