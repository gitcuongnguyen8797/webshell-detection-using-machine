<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="lichcd.aspx.vb" MasterPageFile="~/hcmpcadmin.master" Inherits="hcmpc.lichcd" %>
	...
	<div class="m">
		<div id="toolbar" class="toolbar-list">
            <ul>
                ...
                <a class="toolbar" href="dslichcd.aspx">
            ...
            <div class="clr"></div>
					...
					<div class="pagetitle icon-48-article-add"><h2>Quản lý lịch cắt điện: <%=IIf(Request("ID") = "", "Lịch cắt điện mới", "Chỉnh sửa lịch cắt điện")%></h2></div>
			</div>
</div>
    ...
    <div class="m">
        <table border="0" width="100%" cellspacing="5">            
            ...
            <tr>
                ...
                <td align="left">
                   <asp:FileUpload ID="upFile" runat="server" Width="500" /> 
                </td>
            </tr>
            <tr>
                <td colspan="2"></td>
                <td>
                <%If urlFile.Trim() <> "" Then%>
                <a href="<%=urlFile%>" target="_blank">
                <asp:Label ID="lblFile" runat="server" Text="" ForeColor="Red"></asp:Label>
                </a>
                <%End If%>
                </td>
            </tr>
