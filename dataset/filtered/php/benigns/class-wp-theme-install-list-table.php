...
class WP_Theme_Install_List_Table extends WP_Themes_List_Table {
	...
	public function display() {
		...
		?><?php
				...
				?><?php $this->pagination( 'top' ); ?><?php $this->display_rows_or_placeholder(); ?><?php
	...
	public function single_row( $theme ) {
		...
		?><?php echo esc_url( $preview_url ); ?><?php echo esc_attr( $preview_title ); ?><?php echo esc_url( $theme->screenshot_url . '?ver=' . $theme->version ); ?><?php echo $name; ?><?php
			/* translators: %s: Theme author. */
			printf( __( 'By %s' ), $author );
		?><?php foreach ( $actions as $action ) : ?><?php echo $action; ?><?php endforeach; ?><?php _e( 'Details' ); ?><?php
	...
	public function theme_installer() {
		?><?php _e( 'Close' ); ?><?php esc_attr_e( 'Collapse Sidebar' ); ?><?php _e( 'Collapse' ); ?><?php
	}
	...
	public function theme_installer_single( $theme ) {
		?><?php $this->install_theme_info( $theme ); ?><?php echo esc_url( $theme->preview_url ); ?><?php
	}
	...
	public function install_theme_info( $theme ) {
		...
		?><?php echo $name; ?><?php
				/* translators: %s: Theme author. */
				printf( __( 'By %s' ), $author );
			?><?php if ( isset( $theme->screenshot_url ) ) : ?><?php echo esc_url( $theme->screenshot_url . '?ver=' . $theme->version ); ?><?php endif; ?><?php
				wp_star_rating(
					array(
						'rating' => $theme->rating,
						'type'   => 'percent',
				...
				?><?php _e( 'Version:' ); ?><?php echo wp_kses( $theme->version, $themes_allowedtags ); ?><?php echo wp_kses( $theme->description, $themes_allowedtags ); ?><?php echo esc_url( $theme->preview_url ); ?>