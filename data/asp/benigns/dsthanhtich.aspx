<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="dsthanhtich.aspx.vb" MasterPageFile="~/hcmpcadmin.master" Inherits="hcmpc.dsthanhtich" %>
		...
		<div id="toolbar" class="toolbar-list">
            <ul>
                <li id="toolbar-new" class="button">
                    <a class="toolbar" href="nhapthanhtich.aspx">
			...
			<div class="pagetitle icon-48-article"><h2>Quản lý Thành tích: Thành tích</h2></div>
		</div>
</div>
    ...
    <div class="m">
        <fieldset id="filter-bar">
		    ...
		    <div class="filter-select fltrt">
                <select onchange="this.form.submit()" class="inputbox" id="filter_loaithanhtich" runat="Server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <telerik:RadGrid ID="mygrid" runat="server" AutoGenerateColumns="False" GridLines="None"
                    ...
                    <MasterTableView DataKeyNames="ThanhTich_ID">                
                        <Columns>
                            <telerik:GridClientSelectColumn UniqueName="ClientSelectColumn">
                               <HeaderStyle Width="50px" HorizontalAlign="Center" />
                               <ItemStyle HorizontalAlign="Center" />
                           </telerik:GridClientSelectColumn>
                            <telerik:GridBoundColumn DataField="ThanhTich_ID" HeaderText="ThanhTich_ID" UniqueName="ThanhTich_ID"
                                Visible="false">
                            </telerik:GridBoundColumn>
                            <telerik:GridHyperLinkColumn DataNavigateUrlFormatString="nhapthanhtich.aspx?ID={0}"
                                DataNavigateUrlFields="ThanhTich_ID" SortExpression="ThanhTich_ID" UniqueName="EditArticle" DataTextField="Title" HeaderText="Tiêu đề">
                            ...
                            <telerik:GridBoundColumn DataField="SmallImage" HeaderText="Tập tin hình ảnh">    
                                <HeaderStyle Font-Bold="true" />                                                  
                            </telerik:GridBoundColumn>      
                             <telerik:GridBoundColumn DataField="Nam" HeaderText="Năm"
                                SortExpression="Nam" UniqueName="Nam">
