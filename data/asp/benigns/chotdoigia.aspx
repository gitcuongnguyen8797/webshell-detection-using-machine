<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/siteadmin.master" CodeBehind="chotdoigia.aspx.vb" Inherits="bckinhdoanh.chotdoigia" 
    title="Theo dõi tình hình chốt chỉ số đổi giá điện từ 01/06/2014" %>
...
<div>
    <table border="0" cellpadding="0" cellspacing="0" width="600px">
        ...
        <tr>
            <td colspan="3" align="left"><div width="50%" align="center"><hr width="50%" height="1px"><b>CHỐT NGÀY 01/06/2014 (TRƯỚC 14 GIỜ)</b></div></td>
        </tr>
         <tr>
            <td colspan="3" height="5px"></td>
        </tr>
        ...
        <tr>
            <td colspan="3" align="left"><div width="50%" align="center"><hr width="50%" height="1px"><b>CHỐT CẢ NGÀY 01/06/2014 (TRƯỚC 24 GIỜ)</b></div></td>
        </tr>
         <tr>
            <td colspan="3" height="5px"></td>
        </tr>
        ...
        <tr style="visibility:hidden;">
         ...
         <tr>
            <td colspan="3" align="left"><div width="50%" align="center"><hr width="50%" height="1px"><b>CHỐT CẢ NGÀY 02/06/2014 (TRƯỚC 24 GIỜ)</b></div></td>
        </tr>
         <tr>
            <td colspan="3" height="5px"></td>
        </tr>
